...
(*
Definition hmac256drbgabs_common_mpreds (final_state_abs: hmac256drbgabs) (old_state: hmac256drbgstate)
                  (ctx: val) (info_contents: reptype t_struct_mbedtls_md_info): mpred :=
...
Definition hmac_drbg_seed_buf_SPEC :=
   WITH ctx: val, info:val, d_len: Z, data:val, Data: list val,
    ...
    PRE [_ctx OF tptr (Tstruct _mbedtls_hmac_drbg_context noattr),
       ...
       SEP (
         (data_at Tsh (tarray tuchar d_len) Data data);
...
freeze [0;1;2;4;5;6;7;8;9;10] FR_mcpy1.
    ...
    rewrite Zmin_spec. destruct (zlt 32 (out_len - n*32)). omega. omega.
    rewrite Zmin_spec. destruct (zlt 32 (out_len - n*32))(*; subst done*). left. exists (n+1). omega. right; omega.
