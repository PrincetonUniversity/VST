...
Definition functions_initialized (g: t) (m: mem) :=
  ...
  /\ (forall ofs k p, isMaxCur k=true -> 
      Mem.perm m b ofs k p -> ofs = 0 /\ perm_order Nonempty p).
...
(* function *)
  ...
  split. intros. eapply B; eauto. erewrite alloc_global_perm; eauto. 
...
(* function *)
  ...
  intros. eapply B; eauto. erewrite alloc_global_perm; eauto.
(* variables *)
