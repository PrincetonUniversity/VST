...
Module Info.
  ...
  Definition source_file := "progs64/input.c".
...
Definition f_main := {|
  ...
  fn_callconv := cc_default;
  fn_params := nil;
  fn_vars := ((_q, (Tstruct _b noattr)) :: nil);
  fn_temps := ((_i, tschar) :: (_j, tint) :: (_t'1, tschar) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sassign (Efield (Evar _q (Tstruct _b noattr)) _y1 tint)
    ...
    (Ssequence
      (Sassign
        (Efield
          (Ederef
            (Ebinop Oadd
              (Efield (Evar _q (Tstruct _b noattr)) _y2
                (tarray (Tstruct _a noattr) 3))
              (Econst_int (Int.repr 0) tint) (tptr (Tstruct _a noattr)))
            (Tstruct _a noattr)) _x1 tdouble)
            ...
            (Efield
              (Ederef
                (Ebinop Oadd
                  (Efield (Evar _q (Tstruct _b noattr)) _y2
                    (tarray (Tstruct _a noattr) 3))
                  (Econst_int (Int.repr 1) tint) (tptr (Tstruct _a noattr)))
                (Tstruct _a noattr)) _x1 tdouble)
            (Econst_float (Float.of_bits (Int64.repr 0)) tdouble))
          (Ssequence
            (Sassign
                ...
                (Ederef
                  (Ebinop Oadd
                    (Efield (Evar _q (Tstruct _b noattr)) _y2
                      (tarray (Tstruct _a noattr) 3))
                    (Econst_int (Int.repr 1) tint)
                    (tptr (Tstruct _a noattr))) (Tstruct _a noattr)) _x2
                ...
                (Efield
                  (Ederef
                    (Ebinop Oadd
                      ...
                      (tptr (Tstruct _a noattr))) (Tstruct _a noattr)) _x1
                  tdouble)
                (Econst_float (Float.of_bits (Int64.repr 0)) tdouble))
              (Ssequence
                (Sassign
                        ...
                        (Ederef
                          (Ebinop Oadd
                            (Efield (Evar _q (Tstruct _b noattr)) _y2
                              (tarray (Tstruct _a noattr) 3))
                            (Econst_int (Int.repr 1) tint)
                            (tptr (Tstruct _a noattr))) (Tstruct _a noattr))
                        _x2 tschar))
                    (Sset _i (Ecast (Etempvar _t'1 tschar) tschar)))
                  (Ssequence
                    (Sset _j (Etempvar _i tschar))
