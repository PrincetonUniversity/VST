...
Module Info.
  ...
  Definition source_file := "bitfield.c".
...
Definition _broken_roundtrip_field1 : ident := $"broken_roundtrip_field1".
Definition _field1 : ident := $"field1".
Definition _field2 : ident := $"field2".
Definition _field3 : ident := $"field3".
Definition _main : ident := $"main".
Definition _my_struct : ident := $"my_struct".
Definition _s : ident := $"s".
Definition _t'1 : ident := 128%positive.

Definition f_broken_roundtrip_field1 := {|
  fn_return := tuint;
  fn_callconv := cc_default;
  fn_params := ((_s, (tptr (Tstruct _my_struct noattr))) :: nil);
  fn_vars := nil;
...
(Ssequence
  (Sassign
    (Efield
      (Ederef (Etempvar _s (tptr (Tstruct _my_struct noattr)))
        (Tstruct _my_struct noattr)) _field1 tint)
    (Econst_int (Int.repr 5000) tint))
  (Ssequence
    (Sset _t'1
      (Efield
        (Ederef (Etempvar _s (tptr (Tstruct _my_struct noattr)))
...
(Composite _my_struct Struct
   (Member_bitfield _field1 I32 Unsigned noattr 4 false ::
    Member_bitfield _field2 I32 Unsigned noattr 12 false ::
    Member_bitfield _field3 I32 Unsigned noattr 16 false :: nil)
   noattr :: nil).
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     (tint :: nil) tvoid
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_broken_roundtrip_field1, Gfun(Internal f_broken_roundtrip_field1)) :: nil).

Definition public_idents : list ident :=
(_broken_roundtrip_field1 :: ___builtin_debug :: ___builtin_fmin ::
