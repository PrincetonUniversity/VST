...
Module Info.
  ...
  Definition source_file := "progs64/field_loadstore.c"%string.
...
Definition _sub1 : ident := 61%positive.
Definition _sub2 : ident := 62%positive.
Definition _sub3 : ident := 64%positive.
