...
Definition _choice_i : ident := $"choice_i".
Definition _choice_p : ident := $"choice_p".
Definition _compute2 : ident := $"compute2".
Definition _const_or_not : ident := $"const_or_not".
...
Definition _fabs_single : ident := $"fabs_single".
...
Definition _p_or_i : ident := $"p_or_i".
...
Definition _unconst : ident := $"unconst".
...
Definition f_fabs_single := {|
  ...
  fn_vars := ((_u, (Tunion __1054 noattr)) :: nil);
  fn_temps := ((_t'2, tuint) :: (_t'1, tfloat) :: nil);
  fn_body :=
(Ssequence
  (Sassign (Efield (Evar _u (Tunion __1054 noattr)) _f tfloat)
    (Etempvar _x tfloat))
  (Ssequence
    (Ssequence
      (Sset _t'2 (Efield (Evar _u (Tunion __1054 noattr)) _i tuint))
      (Sassign (Efield (Evar _u (Tunion __1054 noattr)) _i tuint)
        (Ebinop Oand (Etempvar _t'2 tuint)
          (Econst_int (Int.repr 2147483647) tint) tuint)))
    (Ssequence
      (Sset _t'1 (Efield (Evar _u (Tunion __1054 noattr)) _f tfloat))
