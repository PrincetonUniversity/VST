...
(*        There was a proof here...  *)
      ...
      { apply updLock_inv.
        ...
        - intros. simpl. inversion dinv. apply lock_res_set in H.
          ...
          rewrite DSEM.ThreadPool.lockSet_spec_1 in H.
          destruct H as [pu H].
          ...
          Proof.
            ...
            - intros i j cnti cntj ineq.
              ...
              + subst j. erewrite DSEM.ThreadPool.gsoAddRes with (cntj0:= cnti0); try eassumption.
                ...
                admit. (*This shouldn't be a thing... check threadPool.v to remove it!!! *)
                reflexivity.
     ...
     (* (Htp': tp' = updThread cnt0 (Kresume c) pmap_tid')
      ...
      - cut (DSEM.invariant ds0).
          ...
          - intros.
            ...
            + {
                ...
                - subst b0. rewrite PTree.gss in e.
                  ...
                  apply permDisjoint_comm.
                  exists (perm_of_res (m_phi jm' @ (b, ofs0)));
                    reflexivity.
                  eassumption.
            ...
            + { unfold virtue in e.            
                ...
                - subst b0.
                  ...
                  destruct (Intv.In_dec ofs0 (Int.intval ofs, Int.intval ofs + LKSIZE)); inversion e0.
                  rewrite DSEM.ThreadPool.gsolockSet_rem2. 2: exact n.
                  unfold pmap_tid.
        ...
        { 
          eapply remLock_inv.
          - assumption.
            (*Seems like all of this is not needed!!! *)
         (* - intros; simpl.
