...
Definition jm_
  ...
  : juicy_mem :=
  personal_mem cnti (thread_mem_compatible (mem_compatible_forget mcompat)).
...
Proof.
  ...
  - unfold juicyRestrict in *; simpl.
    ...
    intros b; repeat f_equal; auto. apply proof_irr.
  - unfold personal_mem in *. simpl. f_equal. apply proof_irr.
Qed.
