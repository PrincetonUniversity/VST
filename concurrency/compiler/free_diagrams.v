...
(*          
        ...
        + !context_goal one_thread_match.
          { eapply build_match_compiled; auto.
            ...
            - Lemma freelock_is_consec:
                consecutive_sem "freelock" UNLOCK_SIG.
              Admitted.
              eapply freelock_is_consec.
            - Lemma freelock_doesnt_return:
                doesnt_return FREE_LOCK.
              Admitted.
            ...
            - simpl.
              Inductive freelock : val -> mem -> mem -> Prop :=
                FreeLockSem : forall b ofs m pdata new_perm m' m''
