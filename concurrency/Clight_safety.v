...
Section safety_Clight.
  ...
  Qed.
    ...
    Lemma Clight_csafe2ksafe:
      forall ge st_ m,
      forall U n, new_valid (nil, st_, m) U ->
             csafe ge (U, nil, st_) m n ->
        (ksafe_new_step ge (U, nil, st_) m n).
    Proof.
      intros.
      induction n;  subst; try solve[ constructor].
      inversion H0; subst.
      - econstructor.
        econstructor. unfold mk_ostate, mk_nstate; simpl.
        
        unfold halted in H1; simpl in H1.
  ...
  (** *CSafety for Clight_core*)
    ...
    (*Now convert the new type of safety*)
