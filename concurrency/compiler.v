(* NOTE: this is an exact copy of CompCert/drive/compiler.v 
   without Csyntax. *)
...
Require Ctypes Csem Cstrategy Cexec.
Require Clight.
Require Csharpminor.
Require Cminor.
Require CminorSel.
...
(* Definition transf_c_program (p:Csynt ax.program) : res Asm.program :=
  OK p
...
Theorem cstrategy_semantic_preservation:
  ...
  match_prog p tp ->
  forward_simulation (
      Clight.semantics p) (Asm.semantics tp)
