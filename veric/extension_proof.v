...
(*OLD PROOFS, LIMITED TO SINGLE CORE IN SOURCE AND TARGET
...
Qed.
 ...
 specialize (RELY _ _ ge ge (cd i) m1 m1' j j' m2 m2' d1 d2 c1 c2 c1' c2' n 
             (csemS k) (csemT k) (core_simulations k) (cd k) cd').
 spec RELY; auto.
 (*8 more subgoals...*)
 Admitted.
