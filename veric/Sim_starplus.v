...
Lemma  ext_simulation_star_wf: Sim_ext.Forward_simulation_extends _ _ Sem1 Sem2 ge1 ge2 entry_points.
Proof.
...
Proof.
  eapply Sim_inj.Build_Forward_simulation_inject with
   ...
   intros.  (*destruct H0; subst.*) clear inj_simulation .
         specialize (inj_after_external _ _ _ _ _ _ _ _ _ _ _ _ _ _ H0 H1 H2 H3 H4 H5 H6 H7 H8 H9 H10 H11).
