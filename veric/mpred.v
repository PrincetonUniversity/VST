...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite eval_id_same : normalize norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite eval_id_other using solve [clear; intro Hx; inversion Hx] : normalize norm.
