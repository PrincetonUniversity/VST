...
Proof. 
  ...
  (*case 2*)
    ...
    right. split. exists O. simpl; auto.
              eapply sem_compose_ord1. apply H0.
...
(*core_diagram*)
 ...
 (*after_external*)
  ...
  destruct ((Coop_forward_simulation_ext.core_after_external SimExt12) _ _ _ _ _ _ _ _ ret1 ret1 _ _ _ MC12 H0 H1 AtExt2 ValsLD12
    HTVals2 H5 Fwd2 UnchOn2 (Val.lessdef_refl _) Ext12' HTR1 H11 WD2' H13 ValV2') 
  as [c1' [c2' [d12' [AftExt1 [AftExt2 MC12']]]]].
  destruct ((Coop_forward_simulation_ext.core_after_external SimExt23) _ _ _ _ _ _ _ _ ret1 ret3 _ _ _ MC23 AtExt2 VV2 AtExt3
...
(core_diagram12 : forall (st1 : C1) (m1 : mem) (st1' : C1) (m1' : mem),
  ...
  epts23 
  (SimInj23 : Coop_forward_simulation_inj.Forward_simulation_inject _
    _ Sem2 Sem3 Genv2 Genv3 epts23)
 ...
 (MatchHyp23: forall d23 j23 c2 m2 c3 m3,  Coop_forward_simulation_inj.match_state SimInj23 d23 j23 c2 m2 c3 m3 ->  
 ...
 (st1 : C1)
  ...
  (CS1 : corestep Sem1 Genv1 st1 m1 st1' m1')
  (d12 : core_data12)
  (d23 : Coop_forward_simulation_inj.core_data SimInj23)
  (st3 : C3)
  (m3 : mem)
  (st2 : C2)
  (m2 : mem)
  ...
  (MC23 : Coop_forward_simulation_inj.match_state SimInj23 d23 j23 st2 m2 st3 m3),
   exists st3' : C3,
     exists m3' : mem,
       exists cd' : core_data12 * option C2 * Coop_forward_simulation_inj.core_data SimInj23,
         exists j' : meminj,
              ...
              exists m2' : mem,
                exists j12' : meminj,
                  exists j23' : meminj,
                    ...
                    Coop_forward_simulation_inj.match_state SimInj23 d2 j23' st2' m2' st3' m3') /\
           (corestep_plus Sem3 Genv3 st3 m3 st3' m3' \/
            corestep_star Sem3 Genv3 st3 m3 st3' m3' /\
            sem_compose_ord_eq_eq core_ord12 
              (clos_trans _ (Coop_forward_simulation_inj.core_ord SimInj23))
             C2 cd' (d12, Some st2, d23)).
Proof. 
  intros. 
 ...
 (*case1*) 
  destruct CS2.
    clear CS1.
    destruct (Coop_forward_simulation_inj.core_diagramN SimInj23 _ _ _ _ _ H _ _ _ _ MC23)
       as [st3' [m3' [d23' [j23' [InjIncr23 [InjSep23 [MC23' X23]]]]]]].
...
Proof. (*
  ...
  eapply Coop_forward_simulation_inj.Build_Forward_simulation_inject with
    (core_ord := sem_compose_ord_eq_eq 
        (Coop_forward_simulation_inj.core_ord SimInj12)
        (clos_trans _ (Coop_forward_simulation_inj.core_ord SimInj23)) C2)
    (match_state := fun d j c1 m1 c3 m3 => 
      match d with (d1,X,d2) => 
        exists c2, exists m2, exists j1, exists j2, 
          ...
          Coop_forward_simulation_inj.match_state SimInj12 d1 j1 c1 m1 c2 m2 /\
          Coop_forward_simulation_inj.match_state SimInj23 d2 j2 c2 m2 c3 m3
      end).
 (*well_founded*)
  eapply well_founded_sem_compose_ord_eq_eq.
      destruct SimInj12. assumption.
      destruct SimInj23. eapply wf_clos_trans. assumption. 
 (*match_wd*) intros. rename c2 into c3.  rename m2 into m3. destruct d as [[d12 cc2] d23]. 
  destruct H as [c2 [m2 [j12 [j23 [X [J [MC12 MC23]]]]]]]; subst.
  split. apply (Coop_forward_simulation_inj.match_memwd SimInj12 _ _ _ _ _ _ MC12).
  apply (Coop_forward_simulation_inj.match_memwd SimInj23 _ _ _ _ _ _ MC23).
 (*match_validblocks*) 
  intros. rename c2 into c3.  rename m2 into m3. destruct d as [[d12 cc2] d23]. 
  destruct H as [c2 [m2 [j12 [j23 [X [J [MC12 MC23]]]]]]]; subst.
  apply compose_meminjD_Some in H0. 
  destruct H0 as [b11 [ofs11 [ofs12 [Hb [Hb1 Hdelta]]]]]. 
  split. eapply (Coop_forward_simulation_inj.match_validblocks SimInj12 _ _ _ _ _ _ MC12); try eassumption.
  eapply (Coop_forward_simulation_inj.match_validblocks SimInj23 _ _ _ _ _ _ MC23); try eassumption.
 (*core_diagram*)
  intros. rename st2 into st3. rename m2 into m3.
  destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [m2 [j12 [j23 [X [? [MC12 MC23]]]]]]]; subst.
  apply (diagram_injinj _ _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
      (Coop_forward_simulation_inj.core_data SimInj12) 
      (Coop_forward_simulation_inj.match_state SimInj12)
        _ _  (Genv.globalenv P1)  (Genv.globalenv P3) 
      (Coop_forward_simulation_inj.core_diagram SimInj12) _ SimInj23
      (Coop_forward_simulation_inj.match_validblocks SimInj12)
      (Coop_forward_simulation_inj.match_validblocks SimInj23)
       _ _ _ _ H _ _ _ _ _ _ _ _ MC12 MC23). 
 (*initial_core*)
  ...
  destruct (Coop_forward_simulation_inj.core_initial SimInj12 _ _ _ EP12 _ _ _ _ _ _ H0 Flat1 H2 H2 ValInjFlat1 HT) 
    as [d12 [c2 [Ini2 MC12]]].
  destruct (Coop_forward_simulation_inj.core_initial SimInj23 _ _ _ EP23 _ _ _ _ _ _  Ini2 H1 H2 H3 H4 H5) 
    as [d23 [c3 [Ini3 MC23]]].
 ...
 (*safely_halted*)
  ...
  apply (Coop_forward_simulation_inj.core_halted SimInj12 _ _ _ _ _ _ _ MC12) in H0; try assumption. 
  destruct H0 as [v2 [ValsInj12 [SH2 [Minj12 VV2]]]].
  apply (Coop_forward_simulation_inj.core_halted SimInj23 _ _ _ _ _ _ _ MC23) in SH2; try assumption. 
...
(*atexternal*)
  ...
  apply (Coop_forward_simulation_inj.core_at_external SimInj12 _ _ _ _ _ _ _ _ _ MC12) in H0; try assumption. 
  destruct H0 as [MInj12 [PGj1 [vals2 [ValsInj12 [HTVals2 [AtExt2 VV2]]]]]].
  apply (Coop_forward_simulation_inj.core_at_external SimInj23 _ _ _ _ _ _ _ _ _ MC23) in AtExt2; try assumption. 
 ...
 (*after_external*) 
  ...
  destruct (Coop_forward_simulation_inj.core_at_external SimInj12 _ _ _ _ _ _ _ _ _ MC12 AtExt1 VV1) 
   as [MInj12 [PGj1 [vals2 [ValsInj12 [HTVals2 [AtExt2 VV2]]]]]].
  destruct (Coop_forward_simulation_inj.core_at_external SimInj23 _ _ _ _ _ _ _ _ _ MC23 AtExt2 VV2) 
  ...
  assert (mem_wd m1 /\ mem_wd m2). 
     apply (Coop_forward_simulation_inj.match_memwd SimInj12 _ _ _ _ _ _ MC12).
  destruct H0 as [WD1 WD2].
  assert (WD3: mem_wd m3).
     apply (Coop_forward_simulation_inj.match_memwd SimInj23 _ _ _ _ _ _ MC23).
  ...
  specialize (Coop_forward_simulation_inj.core_after_external SimInj12 _ _ j12' _ _ _ _ _ ret1 m1' m2 m2' ret2 _ MInj12 MC12 AtExt1
    VV1 PGj1 Incr12 Sep12 MInj12' injRet12 H8 Unch111' Fwd2 Unch22 HasTp2 H13 WD2' H15 ValV2).
  intros AfterExt12. destruct AfterExt12 as [d12' [c1' [c2' [AftExt1 [AftExt2 MC12']]]]].

  specialize (Coop_forward_simulation_inj.core_after_external SimInj23 _ _ j23' _ _ _ _ vals2 ret2 m2' _ m3' ret3 _ MInj23 MC23 
    AtExt2 VV2 PGj2 Incr23 Sep23 MInj23' injRet23 Fwd2 Unch222' H10 Unch2233' H12 WD2'
    H14 ValV2 H16).
  intros AfterExt23. destruct AfterExt23 as [d23' [cc2' [c3' [AftExt22 [AftExt3 MC23']]]]].
  rewrite AftExt22 in AftExt2. inv AftExt2.
...
(Genv3 : G3)
  epts23 
  (SimEq23 : Forward_simulation_eq.Forward_simulation_equals _
    _ _ Sem2 Sem3 Genv2 Genv3 epts23)
(c1 : C1)
(m1 : mem)
(c1' : C1)
(m1' : mem)
...
(d12 : core_data12)
(d23 :Forward_simulation_eq.core_data SimEq23)
(c3 : C3)
(c2 : C2)
(MC12 : match_core12 d12 c1 c2)
(MC23 : Forward_simulation_eq.match_core SimEq23 d23 c2 c3),
exists st2' : C3,
  exists d' : core_data12 * option C2 * (Forward_simulation_eq.core_data SimEq23),
    (let (y, d2) := d' in
     let (d1, X) := y in
     exists c0 : C2,
       X = Some c0 /\
       match_core12 d1 c1' c0 /\ 
       Forward_simulation_eq.match_core SimEq23 d2 c0 st2') /\
    (corestep_plus Sem3 Genv3 c3 m1 st2' m1' \/
     corestep_star Sem3 Genv3 c3 m1 st2' m1' /\
     sem_compose_ord_eq_eq core_ord12 
          (clos_trans _ (Forward_simulation_eq.core_ord SimEq23))
          C2 d' (d12, Some c2, d23)).
Proof. 
  intros.   
  ...
  (*case1*)
    destruct CS2.
    clear CS1.
    destruct (Forward_simulation_eq.core_diagramN SimEq23 _ _ _ _ _ H _ _ MC23)
      as [st3' [d23' [MC23' X23]]].
    exists st3'. exists (d12',Some c2',d23').
    split. exists c2'. repeat (split; trivial).
    destruct X23 as [X23 | [X23 ORD23]].
    left. assumption.
    right. split. assumption. 
              eapply sem_compose_ord2. apply ORD23.
...
(*  destruct SimEq12 as [core_data12 match_core12 core_ord12 core_ord_wf12 core_diagram12 
  ...
  eapply Forward_simulation_eq.Build_Forward_simulation_equals with
    (core_data:= prod (prod (Forward_simulation_eq.core_data SimEq12) (option C2)) 
                                   (Forward_simulation_eq.core_data SimEq23)) 
    (match_core := fun d c1 c3 => match d with (d1,X,d2) => 
      exists c2, X=Some c2 /\
         Forward_simulation_eq.match_core SimEq12 d1 c1 c2 /\
         Forward_simulation_eq.match_core SimEq23 d2 c2 c3 end)
    (core_ord := sem_compose_ord_eq_eq (Forward_simulation_eq.core_ord SimEq12)
                            (clos_trans _ (Forward_simulation_eq.core_ord SimEq23)) C2).
           (*wellfounded*) 
  eapply well_founded_sem_compose_ord_eq_eq.
     destruct SimEq12. assumption.
     destruct SimEq23. eapply wf_clos_trans. assumption.
           (*core_diagram*) 
  intros. destruct d as [[d12 cc2] d23]. destruct H0 as [c2 [X [? ?]]]; subst.
  apply (diagram_eqeq _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
     (Forward_simulation_eq.core_data SimEq12) 
     (Forward_simulation_eq.match_core SimEq12)
      _ _ _ (Forward_simulation_eq.core_diagram  SimEq12)
      _ _ SimEq23 _ _ _ _ H); assumption.
           (*initial_core*)
  intros. rename v2 into v3. rewrite (EPC v1 v3 sig) in H. destruct H as [v2 [EP12 EP23]].
  destruct (Forward_simulation_eq.core_initial SimEq12 _ _ _ EP12 _ H0) as [d12 [c1 [c2 [Ini1 [Ini2 MC12]]]]].
  destruct (Forward_simulation_eq.core_initial SimEq23 _ _ _ EP23 _ H0) as [d23 [c22 [c3 [Ini22 [Ini3 MC23]]]]].
  rewrite Ini22 in Ini2. inv Ini2.
  exists (d12,Some c2,d23). exists c1. exists c3. split; trivial. split; trivial. 
  ...
  apply (Forward_simulation_eq.core_halted SimEq12 _ _ _ _ MC12) in H0.
  apply (Forward_simulation_eq.core_halted SimEq23 _ _ _ _ MC23) in H0. assumption.
           (*atexternal*)
  intros. rename st2 into st3. destruct d as [[d12cc2]  d23]. 
    destruct H as [st2 [X [MC12 MC23]]]; subst.
  apply (Forward_simulation_eq.core_at_external SimEq12 _ _ _ _ _ _ MC12) in H0. destruct H0.
  apply (Forward_simulation_eq.core_at_external SimEq23 _ _ _ _ _ _ MC23) in H. assumption.  
          (*after_external*)
  intros. rename st2 into st3. destruct d as [[d12 cc2] d23]. 
    destruct H as [st2 [X [MC12 MC23]]]; subst.
  destruct (Forward_simulation_eq.core_at_external SimEq12 _ _ _ _ _ _ MC12 H0)  as [AtExt2 _].
  destruct (Forward_simulation_eq.core_after_external SimEq12 _ _ _ _ _ _ _ MC12 H0 AtExt2 H2 H3) 
    as [c1' [c2' [d12' [AftExt1 [AftExt2 MS12']]]]].
  destruct (Forward_simulation_eq.core_after_external SimEq23 _ _ _ _ _ _ _ MC23 AtExt2 H1 H2 H3) 
...
(MC23: Coop_forward_simulation_ext.match_state SimExt23 d23 st2 m1 st3 m3),
exists st2' : C3,
  exists m2' : mem,
    exists cd' : core_data12 * option C2 * (Coop_forward_simulation_ext.core_data SimExt23),
      (let (y, d2) := cd' in
       ...
       exists c2 : C2,
         X = Some c2 /\
         match_core12 d1 st1' c2 /\ 
         Coop_forward_simulation_ext.match_state SimExt23 d2 c2 m1' st2' m2') /\
      (corestep_plus Sem3 Genv3 st3 m3 st2' m2' \/
       corestep_star Sem3 Genv3 st3 m3 st2' m2' /\
       sem_compose_ord_eq_eq core_ord12 
           (clos_trans _ (Coop_forward_simulation_ext.core_ord SimExt23))
           C2 cd' (d12, Some st2, d23)).
Proof. intros.
    ...
    destruct (Coop_forward_simulation_ext.core_diagramN SimExt23 _ _ _ _ _ H _ _ _ MC23)
      as [st3' [m3' [d23' [MC23' X23]]]].
    exists st3'. exists m3'.  exists (d12',Some st2',d23').
    split. exists st2'. repeat (split; trivial).
    destruct X23 as [X23 | [X23 ORD23]].
    left. assumption.
    right. split. assumption. 
              eapply sem_compose_ord2. apply ORD23.
...
Proof. (*
  ...
  eapply Coop_forward_simulation_ext.Build_Forward_simulation_extends with
    (match_state := fun d c1 m1 c3 m3 => match d with (d1,X,d2) => 
       exists c2, X = Some c2 /\ 
          Forward_simulation_eq.match_core SimEq12 d1 c1 c2 /\
          Coop_forward_simulation_ext.match_state SimExt23 d2 c2 m1 c3 m3 end)
    (core_data:= prod (prod (Forward_simulation_eq.core_data SimEq12) (option C2)) 
                                   (Coop_forward_simulation_ext.core_data SimExt23))
    (core_ord := sem_compose_ord_eq_eq 
                             (Forward_simulation_eq.core_ord SimEq12) 
                             (clos_trans _ (Coop_forward_simulation_ext.core_ord SimExt23)) C2). 
           (*well_founded*)
  eapply well_founded_sem_compose_ord_eq_eq.
       destruct SimEq12. assumption.
       destruct SimExt23. eapply wf_clos_trans. assumption. 
            (*match_wd*) intros. rename c2 into c3.  rename m2 into m3. 
            destruct d as [[d12 cc2] d23]. 
  destruct H as [c2 [X [MC12 MC23]]]; subst.
  apply (Coop_forward_simulation_ext.match_memwd SimExt23 _ _ _ _ _ MC23).
            (*match_validblocks*) intros. rename c2 into c3.  rename m2 into m3. destruct d as [[d12 cc2] d23]. 
  destruct H as [c2 [X [MC12 MC23]]]; subst.
  eapply (Coop_forward_simulation_ext.match_validblocks SimExt23 _ _ _ _ _ MC23); try eassumption.
           (*core_diagram*) 
  intros. rename st2 into st3.
  destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [X [? ?]]]; subst. rename m2 into m3.
  apply (diagram_eqext _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
         (Forward_simulation_eq.core_data SimEq12)
         (Forward_simulation_eq.match_core SimEq12)
          _ _ _ (Forward_simulation_eq.core_diagram SimEq12)
          _ _ SimExt23 _ _ _ _ H _ _ _ _ _ H0 H1).
           (*initial_core*)
  intros. rename v2 into v3. rewrite (EPC v1 v3 sig) in H. destruct H as [v2 [EP12 EP23]].
  assert (HT: Forall2 Val.has_type vals (sig_args sig)). eapply forall_lessdef_hastype; eauto.
  destruct (Forward_simulation_eq.core_initial SimEq12 _ _ _ EP12 _ HT) as [d12 [c1 [c2 [Ini1 [Ini2 MC12]]]]].
  destruct (Coop_forward_simulation_ext.core_initial SimExt23 _ _ _ EP23 _ _ _ _ H0 H1 H2 H3 H4) as [d23 [c22 [c3 [Ini22 [Ini3 MC23]]]]].
  rewrite Ini22 in Ini2. inv Ini2.
  exists (d12,Some c2,d23). exists c1. exists c3. 
  ...
  apply (Forward_simulation_eq.core_halted SimEq12 _ _ _ _ MC12) in H0.
  apply (Coop_forward_simulation_ext.core_halted SimExt23 _ _ _ _ _ _ MC23) in H0. assumption. assumption.
           (*atexternal*)
  intros. rename st2 into st3. destruct cd as [[d12 cc2] d23]. destruct H as [st2 [X [MC12 MC23]]].
  apply (Forward_simulation_eq.core_at_external SimEq12 _ _ _ _ _ _ MC12) in H0. destruct H0.
  apply (Coop_forward_simulation_ext.core_at_external SimExt23 _ _ _ _ _ _ _ _ MC23) in H. assumption. assumption.
           (*after_external*)
  intros. rename st2 into st3. destruct cd as [[d12 cc2] d23]. destruct H as [st2 [X [MC12 MC23]]].
  destruct (Forward_simulation_eq.core_at_external SimEq12 _ _ _ _ _ _ MC12 H0)  as [AtExt2 _].
  ...
  destruct (Forward_simulation_eq.core_after_external SimEq12 _ _ _ _ _ _ _ MC12 H0 AtExt2 HVals1 HRet1) 
    as [c1' [c2' [d12' [AftExt1 [AftExt2 MS12']]]]].
  destruct (Coop_forward_simulation_ext.core_after_external SimExt23 _ _ _ _ _ _ _ _ _ _ _ _ _ MC23 AtExt2 H1 H2 H3 H4 H5 H6 H7 H8 H9 
...
(st2 : C2)
(MC12: match_core12 d12 st1 st2)
(MC23: Coop_forward_simulation_inj.match_state SimInj23 d23 j st2 m1 st3 m3),
exists st2' : C3,
  exists m2' : mem,
    exists cd' : core_data12 * option C2 * Coop_forward_simulation_inj.core_data SimInj23,
      exists j' : meminj,
        ...
        (let (y, d2) := cd' in
         ...
         exists c2 : C2,
           X = Some c2 /\
           match_core12 d1 st1' c2 /\
           Coop_forward_simulation_inj.match_state SimInj23 d2 j' c2 m1' st2' m2') /\
        (corestep_plus Sem3 Genv3 st3 m3 st2' m2' \/
         corestep_star Sem3 Genv3 st3 m3 st2' m2' /\
         sem_compose_ord_eq_eq core_ord12
                  (clos_trans _ (Coop_forward_simulation_inj.core_ord SimInj23))
...
Proof. intros.
    ...
    clear CS1.
    destruct (Coop_forward_simulation_inj.core_diagramN SimInj23 _ _ _ _ _ H _ _ _ _ MC23)
      as [st3' [m3' [d23' [j' [InjInj23 [InjSep23 [MC23' X23]]]]]]].
         ...
         destruct SimInj23 as [core_data23 match_core23 core_ord23 core_ord_wf23 match_memwd23
          ...
          eapply Coop_forward_simulation_inj.Build_Forward_simulation_inject with
                 (core_ord := sem_compose_ord_eq_eq 
                          (Forward_simulation_eq.core_ord SimEq12)
                          (clos_trans _ (Coop_forward_simulation_inj.core_ord SimInj23)) C2)
                 (match_state := fun d j c1 m1 c3 m3 => match d with (d1,X,d2) =>
                         exists c2, X=Some c2 /\
                         Forward_simulation_eq.match_core SimEq12 d1 c1 c2 /\
                         Coop_forward_simulation_inj.match_state SimInj23 d2 j c2 m1 c3 m3 end).
            (*well_founded*)
                 eapply well_founded_sem_compose_ord_eq_eq.
                    destruct SimEq12. assumption.
                    destruct SimInj23. eapply wf_clos_trans. assumption.
            ...
            (*core_diagram*)
                 intros. rename st2 into st3.
                 destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [X [? ?]]]; subst. rename m2 into m3.
                 apply (diagram_eqinj _ _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
                       (Forward_simulation_eq.core_data SimEq12)
                       (Forward_simulation_eq.match_core SimEq12) 
                       _ _ _ (Forward_simulation_eq.core_diagram SimEq12)
                       _ _ SimInj23 _ _ _ _ H _ _ _ _ _ _ H0 H1).
            (*initial_core*)
                  intros. rename v2 into v3. rewrite (EPC v1 v3 sig) in H. destruct H as [v2 [EP12 EP23]].
                  assert (HT: Forall2 Val.has_type vals1 (sig_args sig)). eapply forall_valinject_hastype; eauto.
                  destruct (Forward_simulation_eq.core_initial SimEq12 _ _ _ EP12 _ HT) as [d12 [c11 [c2 [Ini1 [Ini2 MC12]]]]]. rewrite Ini1 in H0. inv H0.
                  destruct (Coop_forward_simulation_inj.core_initial SimInj23 _ _ _ EP23 _ _ _ _ _ _  Ini2 H1 H2 H3 H4 H5) as [d23 [c3 [Ini3 MC23]]].
             ...
             (*safely_halted*)
                    ...
                    apply (Forward_simulation_eq.core_halted SimEq12 _ _ _ _ MC12) in H0; try assumption.
                    apply (Coop_forward_simulation_inj.core_halted SimInj23 _ _ _ _ _ _ _ MC23) in H0; try assumption.
             (*atexternal*)
                    intros. rename st2 into st3. destruct cd as [[d12 cc2] d23]. 
                    destruct H as [c2 [X [MC12 MC23]]]; subst. 
                    apply (Forward_simulation_eq.core_at_external SimEq12 _ _ _ _ _ _ MC12) in H0. destruct H0.
                    apply (Coop_forward_simulation_inj.core_at_external SimInj23 _ _ _ _ _ _ _ _ _ MC23) in H; try assumption. 
             ...
             (*after_external*)
                    ...
                    destruct (Forward_simulation_eq.core_at_external SimEq12 _ _ _ _ _ _ MC12 H1)  as [AtExt2 HVals1]; try assumption.
                    assert (HRet1:   Val.has_type ret1 (proj_sig_res ef_sig)). eapply valinject_hastype; eassumption.
                    destruct (Forward_simulation_eq.core_after_external SimEq12 _ _ _ _ _ _ _ MC12 H1 AtExt2 HVals1 HRet1) as [c1' [c2' [d12' [AftExt1 [AftExt2 MS12']]]]].
                    assert (PG2: meminj_preserves_globals (Genv.globalenv P2) j). admit. (*meminjpreservesglobals*)
                    destruct (Coop_forward_simulation_inj.core_after_external SimInj23 _ _ _ _ _ _ _ _ _ _ _ _ _ _ H MC23 AtExt2 H2 PG2 H4
...
(MC23: Forward_simulation_eq.match_core SimEq23 d23 st2 st3),
exists st3' : C3,
  exists m3' : mem,
    exists cd' : core_data12 * option C2 * Forward_simulation_eq.core_data SimEq23,
      (let (y, d2) := cd' in
       let (d1, X) := y in
       exists c2 : C2,
         X = Some c2 /\
         match_core12 d1 st1' m1' c2 m3' /\
         Forward_simulation_eq.match_core SimEq23 d2 c2 st3') /\
      (corestep_plus Sem3 Genv3 st3 m3 st3' m3' \/
       corestep_star Sem3 Genv3 st3 m3 st3' m3' /\
      sem_compose_ord_eq_eq core_ord12 
           (clos_trans _ (Forward_simulation_eq.core_ord SimEq23))
...
Proof. (*
  ...
  eapply Coop_forward_simulation_ext.Build_Forward_simulation_extends with 
                 (core_ord := sem_compose_ord_eq_eq 
                       (Coop_forward_simulation_ext.core_ord SimExt12)
                       (clos_trans _ (Forward_simulation_eq.core_ord SimEq23)) C2)
                 (match_state := fun d c1 m1 c3 m3 => match d with (d1,X,d2) =>
                    exists c2, X=Some c2 /\
                    Coop_forward_simulation_ext.match_state SimExt12 d1 c1 m1 c2 m3 /\
                    Forward_simulation_eq.match_core SimEq23 d2 c2 c3 end).
            (*well_founded*)
                 eapply well_founded_sem_compose_ord_eq_eq.
                   destruct SimExt12. assumption.
                   destruct SimEq23. eapply wf_clos_trans. assumption.
            (*match_wd*) intros. rename c2 into c3.  rename m2 into m3. destruct d as [[d12 cc2] d23]. 
                         destruct H as [c2 [X [MC12 MC23]]]; subst.
                         apply (Coop_forward_simulation_ext.match_memwd SimExt12 _ _ _ _ _ MC12).
            (*match_validblocks*) intros. rename c2 into c3.  rename m2 into m3. destruct d as [[d12 cc2] d23]. 
                         destruct H as [c2 [X [MC12 MC23]]]; subst.
                         eapply (Coop_forward_simulation_ext.match_validblocks SimExt12 _ _ _ _ _ MC12); try eassumption.
            (*core_diagram*)
                 intros. rename st2 into st3.
                 destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [X [? ?]]]; subst. rename m2 into m3.
                 apply (diagram_exteq _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
                       (Coop_forward_simulation_ext.core_data SimExt12)
                       (Coop_forward_simulation_ext.match_state SimExt12)
                        _ _ _ (Coop_forward_simulation_ext.core_diagram SimExt12)
                        _ _ SimEq23 _ _ _ _ H _ _ _ _ _ H0 H1). 
            (*initial_core*)
                  intros. rename v2 into v3. rewrite (EPC v1 v3 sig) in H. destruct H as [v2 [EP12 EP23]].
                  destruct (Coop_forward_simulation_ext.core_initial SimExt12 _ _ _ EP12 _ _ _ _ H0 H1 H2 H3 H4) as [d12 [c1 [c2 [Ini1 [Ini2 MC12]]]]].
                  destruct (Forward_simulation_eq.core_initial SimEq23 _ _ _ EP23 _ H1) as [d23 [c22 [c3 [Ini22 [Ini3 MC23]]]]].
                  rewrite Ini22 in Ini2. inv Ini2.
                  exists (d12,Some c2, d23). exists c1. exists c3. 
                  split; trivial. split; trivial. exists c2. split; trivial. split; trivial.
             (*safely_halted*)
                    intros. rename st2 into c3.  destruct cd as [[d12 cc2] d23]. destruct H as [c2 [X [MC12 MC23]]]; subst. 
                    apply (Coop_forward_simulation_ext.core_halted SimExt12 _ _ _ _ _ _ MC12) in H0. destruct H0 as [v2 [LD [SH2 Ext]]].
                    apply (Forward_simulation_eq.core_halted SimEq23 _ _ _ _ MC23) in SH2. exists v2. split; trivial. split; trivial. assumption.
             (*atexternal*)
                    intros. rename st2 into st3. destruct cd as [[d12 cc2] d23]. destruct H as [c2 [X [MC12 MC23]]]; subst.
                    apply (Coop_forward_simulation_ext.core_at_external SimExt12 _ _ _ _ _ _ _ _ MC12) in H0. 
                      destruct H0 as [vals2 [Ext [LD [HT2 [AtExt2 VV2]]]]].
                      destruct (Forward_simulation_eq.core_at_external SimEq23 _ _ _ _ _ _ MC23 AtExt2). 
                      exists vals2. split; trivial. split; trivial. split; trivial. split; assumption.  
                    assumption.
             (*after_external*)
                    intros. rename st2 into st3. destruct cd as [[d12 cc2] d23]. destruct H as [c2 [X [MC12 MC23]]]; subst.
                     rename vals2 into vals3. rename ret2 into ret3.
                    assert (X:=Coop_forward_simulation_ext.core_at_external SimExt12 _ _ _ _ _ _ _ _ MC12 H0 H1). destruct X as [vals2 [Ext [LD [HT2 [AtExt2 VV2]]]]]. 
                    assert (X:=Forward_simulation_eq.core_at_external SimEq23 _ _ _ _ _ _ MC23 AtExt2). 
                    destruct X as [AtExt3 HTargs2]. rewrite AtExt3 in H2. inv H2.
                    destruct (Coop_forward_simulation_ext.core_after_external SimExt12 _ _ _ _ _ _ _ _ _ _ _ _ _ MC12 H0 H1 AtExt2
                         LD HT2 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14) as [c1' [c2' [d12' [AftExt1 [AftExt2 MS12']]]]].
                    destruct (Forward_simulation_eq.core_after_external SimEq23 _ _ _ _ _ _ _ MC23 AtExt2 AtExt3 HT2 H10) 
                         as [c22' [c3' [d23' [AftExt22 [AftExt3 MS23']]]]].
                    rewrite AftExt22 in AftExt2. inv AftExt2.
                    exists c1'. exists c3'. exists (d12',Some c2', d23'). 
                    split; trivial. split; trivial. exists c2'. split; trivial. split; trivial.
...
(m2 : mem)
(MC12 : match_core12 d12 st1 m1 st2 m2)
(MC23 : Coop_forward_simulation_inj.match_state SimInj23 d23 j st2 m2 st3 m3)
        ...
        (let (y, d2) := cd' in
         ...
         exists c2 : C2,
           exists m2' : mem,
             X = Some c2 /\
             match_core12 d1 st1' m1' c2 m2' /\
             Coop_forward_simulation_inj.match_state SimInj23 d2 j' c2 m2' st3' m3') /\
        (corestep_plus Sem3 Genv3 st3 m3 st3' m3' \/
         corestep_star Sem3 Genv3 st3 m3 st3' m3' /\
         sem_compose_ord_eq_eq core_ord12 
              (clos_trans _ (Coop_forward_simulation_inj.core_ord SimInj23))
...
Proof. intros.
    ...
    exists st3'. exists m3'. exists (d12',Some st2',d23'). exists j'.
      split. trivial.
      split. split. intros N. apply (match_validblocks12 _ _ _ _ _ MC12) in N. 
                         destruct (InjSep23 _ _ _ H0 H1). apply (H2 N).
                         destruct (InjSep23 _ _ _ H0 H1). assumption.
      split. exists st2'. exists m2'. repeat (split; trivial).
      destruct X23 as [X23 | [X23 ORD23]].
      left. assumption.
      right. split. assumption. 
                eapply sem_compose_ord2. apply ORD23.
          ...
          eapply Coop_forward_simulation_inj.Build_Forward_simulation_inject with
                 ...
                 (match_state := fun d j c1 m1 c3 m3 => match d with (d1,X,d2) =>
                            exists c2, exists m2, X=Some c2 /\ 
                                   Coop_forward_simulation_ext.match_state SimExt12 d1 c1 m1 c2 m2 /\
                                   Coop_forward_simulation_inj.match_state SimInj23 d2 j c2 m2 c3 m3 end).
            (*well_founded*)
                 eapply well_founded_sem_compose_ord_eq_eq.
                    destruct SimExt12. assumption.
                    destruct SimInj23. eapply wf_clos_trans. assumption.
            ...
            (*match_validblocks*) intros. rename c2 into c3.  rename m2 into m3. destruct d as [[d12 cc2] d23]. 
                         destruct H as [c2 [m2 [X [MC12 MC23]]]]; subst.
                         destruct (Coop_forward_simulation_inj.match_validblocks SimInj23 _ _ _ _ _ _ MC23 _ _ _ H0). 
                         split; trivial. 
                         eapply (Coop_forward_simulation_ext.match_validblocks SimExt12 _ _ _ _ _ MC12); try eassumption.
            (*core_diagram*)
                 intros. rename st2 into st3. rename m2 into m3.
                 destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [m2 [X [? ?]]]]; subst.
                 apply (diagram_extinj _ _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
                       (Coop_forward_simulation_ext.core_data SimExt12) 
                       (Coop_forward_simulation_ext.match_state SimExt12)
                       _ _ _ (Coop_forward_simulation_ext.core_diagram SimExt12) _ _ SimInj23 _ _ _ _ H _ _ _ _ _ _ _ H0 H1).
                   intros. eapply (Coop_forward_simulation_ext.match_validblocks SimExt12 _ _ _ _ _ H2). apply H3.
            (*initial_core*)
                  ...
                  destruct (Coop_forward_simulation_ext.core_initial SimExt12 _ _ _ EP12 _ _ _ _ ( forall_lessdef_refl _) HT (Mem.extends_refl m1) H2 H2)
             ...
             (*after_external*) 
                    ...
                    destruct (Coop_forward_simulation_ext.core_at_external SimExt12 _ _ _ _ _ _ _ _ MC12 H1)  as 
                       [vals2 [Ext12 [LDVals12 [HTVals2 [AtExt2 VV2]]]]]; try assumption.
                    destruct (Coop_forward_simulation_inj.core_at_external SimInj23 _ _ _ _ _ _ _ _ _  MC23 AtExt2)  as 
                       [Inj23 [PG2 [vals3 [InjVals23 [HTVals3 [AtExt3 VV3]]]]]]; try assumption.
                    assert (HVals1:  Forall2 Val.has_type vals1 (sig_args ef_sig)). 
                    ...
                    assert (WD2: mem_wd m2).
                         eapply (Coop_forward_simulation_ext.match_memwd SimExt12). apply MC12. 
                    ...
                    destruct (Coop_forward_simulation_ext.core_after_external SimExt12 _ _ _ _ _ _ _ _ ret1 ret1 _ _ _ MC12 H1 H2 AtExt2 
                              LDVals12 HTVals2 H8 Fwd2' UnchOn2 (Val.lessdef_refl _) Ext12' HRet1) 
                         as [c1' [c2' [d12' [AftExt1 [AftExt2 MC12']]]]]; try assumption.
                    destruct (Coop_forward_simulation_inj.core_after_external SimInj23 _ j j' _ _ _ _ vals2 ret1 _ _ _ ret3 _ Inj23 
                              MC23 AtExt2 VV2 PG2 H4 Sep23 Inj23' H7 Fwd2' UnchOn2j H10 UnchOn3 H12)
                         as [d23' [cc2' [c3' [AftExt22 [AftExt3 MC23']]]]]; try assumption.
                    rewrite AftExt22 in AftExt2. inv AftExt2.
                    exists (d12',Some c2', d23'). exists c1'. exists c3'. split; trivial. split; trivial.
                    exists c2'. exists m2'. split; trivial. split; trivial.
Qed.
    ...
    exists cd' : core_data12 * option C2 * Forward_simulation_eq.core_data SimEq23,
      exists j' : meminj,
        ...
        (let (y, d2) := cd' in
         ...
         exists c2 : C2,
           X = Some c2 /\
           match_core12 d1 j' st1' m1' c2 m2' /\ 
           Forward_simulation_eq.match_core SimEq23 d2 c2 st3') /\
   ...
   destruct SimEq23 as [core_data23 match_core23 core_ord23 core_ord_wf23 core_diagram23 core_initial23 core_halted23 core_at_external23 core_after_external23].*)
    eapply Coop_forward_simulation_inj.Build_Forward_simulation_inject with
                 ...
                 (match_state := fun d j c1 m1 c3 m3 => match d with (d1,X,d2) => exists c2, X=Some c2 /\
                                  Coop_forward_simulation_inj.match_state SimInj12 d1 j c1 m1 c2 m3 /\ 
                                  Forward_simulation_eq.match_core SimEq23 d2 c2 c3 end).
            (*well_founded*)
                 eapply well_founded_sem_compose_ord_eq_eq.
                    destruct SimInj12. assumption.
            ...
            (*match_validblocks*) intros. rename c2 into c3.  rename m2 into m3. destruct d as [[d12 cc2] d23]. 
                         destruct H as [c2 [X [MC12 MC23]]]; subst.
                         eapply (Coop_forward_simulation_inj.match_validblocks  SimInj12 _ _ _ _ _ _ MC12); try eassumption.
            (*core_diagram*)
                 intros. rename st2 into st3.
                 destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [X [? ?]]]; subst.
                 apply (diagram_injeq _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
                         (Coop_forward_simulation_inj.core_data SimInj12)
                         (Coop_forward_simulation_inj.match_state SimInj12)
                         _ _ _ (Coop_forward_simulation_inj.core_diagram SimInj12)
                         _ _ SimEq23 _ _ _ _ H _ _ _ _ _ _ H0 H1).
             (*initial_core*)
                  intros. rename v2 into v3. rewrite (EPC v1 v3 sig) in H. destruct H as [v2 [EP12 EP23]].
                  destruct (Coop_forward_simulation_inj.core_initial SimInj12 _ _ _ EP12 _ _ _ _ _ _ H0 H1 H2 H3 H4 H5) as [d12 [c2 [Ini2 MC12]]].
                  destruct (Forward_simulation_eq.core_initial SimEq23 _ _ _ EP23 _ H5) as [d23 [c22 [c3 [Ini22 [Ini3 MC23]]]]].
                  rewrite Ini22 in Ini2. inv Ini2.
             ...
             (*safely_halted*)
                    ...
                    apply (Forward_simulation_eq.core_halted SimEq23 _ _ _ _ MC23) in SH2; try assumption.
             ...
             (*atexternal*)
                    ...
                    destruct (Forward_simulation_eq.core_at_external SimEq23 _ _ _ _ _ _ MC23 AtExt2); try assumption.
                    split; trivial.
                    split; trivial.
             ...
             (*after_external*)
                    ...
                    destruct (Coop_forward_simulation_inj.core_at_external SimInj12 _ _ _ _ _ _ _ _ _ MC12 H1) as 
                       [MInj12 [PG1j [vals2 [VInj12 [HT2 [AtExt2 VV2]]]]]]; try assumption.
                    destruct (Forward_simulation_eq.core_at_external SimEq23 _ _ _ _ _ _ MC23 AtExt2) as [AtExt3 HTargs2]; try assumption. 
                    destruct (Coop_forward_simulation_inj.core_after_external SimInj12 _ _ _ _ _ _ _ _ _ _ _ _ _ _ MInj12 MC12 H1 
                               H2 PG1j H4 H5 H6 H7 H8 H9 H10 H11 H12 H13 H14 H15 H16)
                             as [d12' [c1' [c2' [AftExt1 [AftExt2 MS12']]]]].
                    destruct (Forward_simulation_eq.core_after_external SimEq23 _ _ _ _ _ _ _ MC23 AtExt2 AtExt3 HT2 H12) 
                        as [c22' [c3' [d23' [AftExt22 [AftExt3 MS23']]]]].
                    rewrite AftExt22 in AftExt2. inv AftExt2.
                    exists (d12',Some c2',d23'). exists c1'. exists c3'.
                    split; trivial. split; trivial.
...
(MatchHyp12: forall d12 j12 c1 m1 c2 m2,  match_core12 d12 j12 c1 m1 c2 m2 ->  
                    forall b1 b2 ofs, j12 b1 = Some (b2,ofs) -> Mem.valid_block m1 b1 /\ Mem.valid_block m2 b2)
(MatchHyp23: forall d23 c2 m2 c3 m3,  Coop_forward_simulation_ext.match_state SimExt23 d23 c2 m2 c3 m3 ->  
        ...
        (let (y, d2) := cd' in
         ...
         exists c2 : C2,
           exists m0 : mem,
             ...
             Coop_forward_simulation_ext.match_state SimExt23 d2 c2 m0 st2' m2') /\
        (corestep_plus Sem3 Genv3 st3 m3 st2' m2' \/
         corestep_star Sem3 Genv3 st3 m3 st2' m2' /\
          sem_compose_ord_eq_eq core_ord12
                (clos_trans _ (Coop_forward_simulation_ext.core_ord SimExt23)) 
...
Proof. intros.
    ...
    exists st3'. exists m3'. exists (d12',Some st2',d23'). exists j'.
      split. trivial.
      split. split. destruct (InjSep _ _ _ H0 H1). apply H2.
                         intros N. apply (MatchHyp23 _ _ _ _ _ MC23) in N. 
                         destruct (InjSep _ _ _ H0 H1). apply (H3 N). 
      split. exists st2'. exists m2'. repeat (split; trivial).
      destruct X23 as [X23 | [X23 ORD23]].
      left. assumption.
      right. split. assumption. 
  ...
  (*case 2*)
    ...
    exists st3. exists m3. exists (d12',Some st2',d23). exists j'.
      split. trivial.
      split. split. destruct (InjSep _ _ _ H H0). apply H1.
                         intros N. apply (MatchHyp23 _ _ _ _ _ MC23) in N. 
                         destruct (InjSep _ _ _ H H0). apply (H2 N).
      split. exists st2'. exists m2'. repeat (split; trivial). 
      right. split. exists O. simpl; auto.
      eapply sem_compose_ord1. apply ord12'. 
Qed.
...
Proof. (*
    ...
    eapply Coop_forward_simulation_inj.Build_Forward_simulation_inject with
                 ...
                 (match_state := fun d j c1 m1 c3 m3 => match d with (d1,X,d2) => 
                       exists c2, exists m2, X = Some c2 /\
                            Coop_forward_simulation_inj.match_state SimInj12 d1 j c1 m1 c2 m2 /\
                            Coop_forward_simulation_ext.match_state SimExt23 d2 c2 m2 c3 m3 end).
            (*well_founded*)
                 eapply well_founded_sem_compose_ord_eq_eq.
                       destruct SimInj12. assumption.
                       destruct SimExt23. eapply wf_clos_trans. assumption. 
            ...
            (*match_validblocks*) intros. rename c2 into c3.  rename m2 into m3. destruct d as [[d12 cc2] d23]. 
                         destruct H as [c2 [m2 [X [MC12 MC23]]]]; subst.
                         destruct (Coop_forward_simulation_inj.match_validblocks SimInj12 _ _ _ _ _ _ MC12 _ _ _ H0).
                         split; try eassumption.
                         eapply (Coop_forward_simulation_ext.match_validblocks SimExt23 _ _ _ _ _ MC23); try eassumption.
            (*core_diagram*)
                 intros. rename st2 into st3. rename m2 into m3.
                 destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [m2 [X [? ?]]]]; subst.
                 apply (diagram_injext _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
                        (Coop_forward_simulation_inj.core_data SimInj12) 
                        (Coop_forward_simulation_inj.match_state SimInj12) 
                        _ _ _ (Coop_forward_simulation_inj.core_diagram SimInj12)
                         _ _ SimExt23 _ _ _ _ H _ _ _ _ _ _ _ H0 H1).
                    apply (Coop_forward_simulation_inj.match_validblocks SimInj12). 
                    apply (Coop_forward_simulation_ext.match_validblocks SimExt23). 
           (*initial_core*)
                  intros. rename m2 into m3. rename v2 into v3. rewrite (EPC v1 v3 sig) in H. destruct H as [v2 [EP12 EP23]].
                  destruct (Coop_forward_simulation_inj.core_initial SimInj12 _ _ _ EP12 _ _ _ _ _ _ H0 H1 H2 H3 H4 H5) as [d12 [c2 [Ini2 MC12]]].
                  destruct (Coop_forward_simulation_ext.core_initial SimExt23 _ _ _ EP23 _ _ _ _ (forall_lessdef_refl _) H5 (extends_refl m3) H3 H3) 
           ...
           (*safely_halted*)
             ...
             (*after_external*)
                    ...
                    destruct cd as [[d12 cc2] d23]. destruct H0 as [c2 [m2 [X [MC12 MC23]]]]; subst.
                    destruct (Coop_forward_simulation_inj.core_at_external SimInj12 _ _ _ _ _ _ _ _ _ MC12 H1) 
                         as [Minj12 [PG1j [vals2 [ValsLD12 [HTVals2 [AtExt2 VV2]]]]]]; try assumption.
                    destruct (Coop_forward_simulation_ext.core_at_external SimExt23 _ _ _ _ _ _ _ _ MC23 AtExt2)
                         as [vals3 [MExt23 [ValsLD23 [HTVals3 [AtExt3 VV3]]]]]; try assumption.
                    ...
                    assert (WD2: mem_wd m2). 
                          apply (Coop_forward_simulation_ext.match_memwd SimExt23) in MC23. apply MC23. 
                    ...
                    destruct (Coop_forward_simulation_inj.core_after_external SimInj12 _ j j' _ _ _ _ _ ret1 m1' _ m2' ret3 _ Minj12 MC12 H1 H2 PG1j H4 
                                         Sep12 Minj12' H7 H8 H9 Fwd2' UnchLOORj1_2 H12 H13 H0 H15 H17)
                            as  [d12' [c1' [c2' [AftExt1 [AftExt2 MC12']]]]].
                    destruct (Coop_forward_simulation_ext.core_after_external SimExt23 _ _ _ _ _ _ _ _ ret3 ret3 _ _ _ MC23 AtExt2 VV2 AtExt3 ValsLD23
...
(* Old proofs (before restructuring of diagram_lemmas
Section EXTEXT2.
Lemma  diagram_extext2: forall
(G1 C1 D1 : Type)
(G2 C2 D2 : Type)
(G3 C3 D3 : Type)
(Sem1 : CoreSemantics G1 C1 mem D1)
...
Lemma extext2: Coop_forward_simulation_ext.Forward_simulation_extends
  (list (ident * globdef F1 V1))
  (list (ident * globdef F3 V3)) Sem1 Sem3 (Genv.globalenv P1)
  (Genv.globalenv P3) entrypoints13. 
Proof. 
...
(*core_diagram*)
  ...
  intros. rename st2 into st3. rename m2 into m3.
  destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [m2 [X [? ?]]]]; subst.
  eapply (diagram_extext2 _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 
...
Lemma injinj2: Coop_forward_simulation_inj.Forward_simulation_inject 
  (list (ident * globdef F1 V1))
  (list (ident * globdef F3 V3)) Sem1 Sem3 (Genv.globalenv P1)
  (Genv.globalenv P3) entrypoints13.
Proof.
 ...
 (*core_diagram*)
  ...
  intros. rename st2 into st3. rename m2 into m3.
  destruct cd as [[d12 cc2] d23]. destruct H0 as [st2 [m2 [j12 [j23 [X [? [MC12 MC23]]]]]]]; subst.
  eapply (diagram_injinj2 _ _ _ _ _ _ _ _ _ Sem1 Sem2 Sem3 core_data12 match_core12 _ _ _ 
