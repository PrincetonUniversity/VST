...
Require Import spec_locks.
Require Import spec_malloc.
Require Import spec_SC_atomics.
Require Import verif_SC_atomics verif_malloc.
...
Definition Gprog := lockImports ++ LockASI.
  ...
  Proof.
    ...
    - Intros r. if_tac; forward_if; try discriminate; try contradiction.
      + forward. simpl lock_specs.lock_inv; entailer!. apply derives_refl.
...
Proof.
  ...
  f_equal.
  setoid_rewrite (@lock_inv_super_non_expansive M); do 2 f_equal.
...
Lemma release_self : funspec_sub spec_locks.release_spec release_spec_self.
Proof.
...
Lemma freelock_self : funspec_sub spec_locks.freelock_spec freelock_spec_self.
Proof.
  unfold funspec_sub; simpl.
