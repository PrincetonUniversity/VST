...
Lemma sublist_app1 {A} i (al bl:list A): 0<= i <= Zlength al ->
  sublist 0 i (al ++ bl) = sublist 0 i al.
Proof. 
  unfold sublist; intros. repeat rewrite Zminus_0_r; repeat rewrite skipn_0.
  apply firstn_app1. rewrite Zlength_correct in H.
  eapply Nat2Z.inj_le. rewrite Z2Nat.id; omega.
Qed.
