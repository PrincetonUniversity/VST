...
Definition _A : ident := 125%positive.
Definition _Ch : ident := 142%positive.
Definition _D : ident := 55%positive.
Definition _D2 : ident := 56%positive.
Definition _I : ident := 59%positive.
Definition _K : ident := 148%positive.
Definition _L : ident := 163%positive.
Definition _L32 : ident := 62%positive.
Definition _M : ident := 127%positive.
Definition _Maj : ident := 143%positive.
Definition _R : ident := 141%positive.
Definition _S : ident := 128%positive.
Definition _Sigma0 : ident := 144%positive.
Definition _Sigma1 : ident := 145%positive.
Definition _X : ident := 57%positive.
Definition _Y : ident := 58%positive.
Definition _Z : ident := 126%positive.
...
Definition _a : ident := 114%positive.
Definition _add : ident := 152%positive.
Definition _add1305 : ident := 106%positive.
Definition _aux : ident := 63%positive.
Definition _aux1 : ident := 85%positive.
Definition _aux1305 : ident := 105%positive.
Definition _b : ident := 92%positive.
Definition _c : ident := 61%positive.
Definition _car25519 : ident := 117%positive.
Definition _carry : ident := 164%positive.
Definition _chk : ident := 170%positive.
Definition _core : ident := 88%positive.
Definition _crypto_box_curve25519xsalsa20poly1305_tweet : ident := 139%positive.
Definition _crypto_box_curve25519xsalsa20poly1305_tweet_afternm : ident := 137%positive.
Definition _crypto_box_curve25519xsalsa20poly1305_tweet_beforenm : ident := 136%positive.
Definition _crypto_box_curve25519xsalsa20poly1305_tweet_keypair : ident := 135%positive.
Definition _crypto_box_curve25519xsalsa20poly1305_tweet_open : ident := 140%positive.
Definition _crypto_box_curve25519xsalsa20poly1305_tweet_open_afternm : ident := 138%positive.
Definition _crypto_core_hsalsa20_tweet : ident := 90%positive.
Definition _crypto_core_salsa20_tweet : ident := 89%positive.
Definition _crypto_hash_sha512_tweet : ident := 151%positive.
Definition _crypto_hashblocks_sha512_tweet : ident := 149%positive.
Definition _crypto_onetimeauth_poly1305_tweet : ident := 110%positive.
Definition _crypto_onetimeauth_poly1305_tweet_verify : ident := 111%positive.
Definition _crypto_scalarmult_curve25519_tweet : ident := 133%positive.
Definition _crypto_scalarmult_curve25519_tweet_base : ident := 134%positive.
Definition _crypto_secretbox_xsalsa20poly1305_tweet : ident := 112%positive.
Definition _crypto_secretbox_xsalsa20poly1305_tweet_open : ident := 113%positive.
Definition _crypto_sign_ed25519_tweet : ident := 169%positive.
Definition _crypto_sign_ed25519_tweet_keypair : ident := 162%positive.
Definition _crypto_sign_ed25519_tweet_open : ident := 178%positive.
Definition _crypto_stream_salsa20_tweet : ident := 101%positive.
Definition _crypto_stream_salsa20_tweet_xor : ident := 100%positive.
Definition _crypto_stream_xsalsa20_tweet : ident := 103%positive.
Definition _crypto_stream_xsalsa20_tweet_xor : ident := 104%positive.
Definition _crypto_verify_16_tweet : ident := 75%positive.
Definition _crypto_verify_32_tweet : ident := 76%positive.
Definition _cswap : ident := 153%positive.
Definition _d : ident := 72%positive.
Definition _den : ident := 172%positive.
Definition _den2 : ident := 173%positive.
Definition _den4 : ident := 174%positive.
Definition _den6 : ident := 175%positive.
Definition _dl64 : ident := 67%positive.
Definition _e : ident := 131%positive.
Definition _f : ident := 132%positive.
Definition _g : ident := 109%positive.
Definition _gf0 : ident := 52%positive.
Definition _gf1 : ident := 53%positive.
Definition _h : ident := 80%positive.
Definition _i : ident := 66%positive.
Definition _in : ident := 78%positive.
Definition _index : ident := 87%positive.
Definition _inv25519 : ident := 129%positive.
Definition _iv : ident := 150%positive.
Definition _j : ident := 83%positive.
Definition _k : ident := 79%positive.
Definition _ld32 : ident := 65%positive.
Definition _loop1aux : ident := 94%positive.
Definition _loop2left : ident := 95%positive.
Definition _loop2right : ident := 96%positive.
Definition _loop3left : ident := 97%positive.
Definition _loop3right : ident := 98%positive.
Definition _m : ident := 84%positive.
Definition _main : ident := 179%positive.
Definition _minusp : ident := 107%positive.
Definition _mlen : ident := 177%positive.
Definition _modL : ident := 165%positive.
Definition _n : ident := 71%positive.
Definition _neq25519 : ident := 122%positive.
Definition _num : ident := 171%positive.
Definition _o : ident := 116%positive.
Definition _out : ident := 77%positive.
Definition _p : ident := 118%positive.
Definition _pack : ident := 157%positive.
Definition _pack25519 : ident := 121%positive.
Definition _par25519 : ident := 123%positive.
Definition _pk : ident := 160%positive.
Definition _pow2523 : ident := 130%positive.
Definition _q : ident := 119%positive.
Definition _r : ident := 108%positive.
Definition _randombytes : ident := 49%positive.
Definition _reduce : ident := 166%positive.
Definition _s : ident := 102%positive.
Definition _scalarbase : ident := 159%positive.
Definition _scalarmult : ident := 158%positive.
Definition _sel25519 : ident := 120%positive.
Definition _set25519 : ident := 115%positive.
Definition _sigma : ident := 91%positive.
Definition _sigma0 : ident := 146%positive.
Definition _sigma1 : ident := 147%positive.
Definition _sk : ident := 161%positive.
Definition _sm : ident := 167%positive.
Definition _smlen : ident := 168%positive.
Definition _st32 : ident := 68%positive.
Definition _t : ident := 82%positive.
Definition _temp : ident := 99%positive.
Definition _ts64 : ident := 69%positive.
Definition _tx : ident := 154%positive.
Definition _ty : ident := 155%positive.
Definition _u : ident := 64%positive.
Definition _u8_aux : ident := 86%positive.
Definition _unpack25519 : ident := 124%positive.
Definition _unpackneg : ident := 176%positive.
Definition _vn : ident := 74%positive.
...
Definition _zi : ident := 156%positive.
...
Definition f_vn := {|
  ...
  fn_params := ((_x, (tptr tuchar)) :: (_y, (tptr tuchar)) :: (_n, tint) ::
                nil);
  fn_vars := nil;
  fn_temps := ((_i, tuint) :: (_d, tuint) :: (_xi, tuchar) :: nil);
  fn_body :=
(Ssequence
          ...
          (Ssequence
            ...
            (Sset _d
              (Ebinop Oor (Etempvar _d tuint)
                (Ebinop Oxor (Etempvar _xi tuchar)
                  (Ederef
...
Definition f_add1305 := {|
  ...
  fn_vars := nil;
  fn_temps := ((_aux1305, tuint) :: (_j, tuint) :: (_u, tuint) :: nil);
  fn_body :=
(Ssequence
      ...
      (Ssequence
        ...
        (Ssequence
          ...
          (Ssequence
            (Sset _u
              (Ebinop Oadd (Etempvar _u tuint)
                (Ebinop Oadd (Etempvar _aux1305 tuint)
                  (Ederef
                    (Ebinop Oadd (Etempvar _c (tptr tuint))
                      (Etempvar _j tuint) (tptr tuint)) tuint) tuint) tuint))
            (Ssequence
              (Sassign
                (Ederef
                  (Ebinop Oadd (Etempvar _h (tptr tuint)) (Etempvar _j tuint)
