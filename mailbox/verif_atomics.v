...
Program Definition load_SC_spec := DECLARE _load_SC
  TYPE AL_type WITH sh : share, tgt : val, i : val, h : hist,
...
Definition Gprog : funspecs := ltac:(with_library prog [acquire_spec; release_spec; surely_malloc_spec;
