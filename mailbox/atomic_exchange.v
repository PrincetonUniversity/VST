...
Definition _acquire : ident := 37%positive.
Definition _atom_int : ident := 36%positive.
Definition _l : ident := 40%positive.
Definition _main : ident := 63%positive.
Definition _release : ident := 38%positive.
Definition _simulate_atomic_exchange : ident := 43%positive.
Definition _tgt : ident := 39%positive.
Definition _v : ident := 41%positive.
