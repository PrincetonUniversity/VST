...
Definition _CAS_RA : ident := 64%positive.
...
Definition _add_item : ident := 78%positive.
Definition _arg : ident := 80%positive.
Definition _entry : ident := 5%positive.
Definition _exit : ident := 54%positive.
Definition _f : ident := 86%positive.
Definition _free : ident := 55%positive.
Definition _freelock2 : ident := 59%positive.
Definition _get_item : ident := 77%positive.
Definition _i : ident := 71%positive.
Definition _i__1 : ident := 87%positive.
Definition _i__2 : ident := 88%positive.
Definition _i__3 : ident := 90%positive.
Definition _idx : ident := 73%positive.
Definition _init_table : ident := 79%positive.
Definition _integer_hash : ident := 72%positive.
Definition _key : ident := 3%positive.
Definition _keys : ident := 91%positive.
Definition _l : ident := 82%positive.
Definition _l__1 : ident := 89%positive.
Definition _load_acq : ident := 62%positive.
Definition _lock_t : ident := 2%positive.
Definition _m_entries : ident := 65%positive.
...
Definition _probed_key : ident := 74%positive.
Definition _r : ident := 85%positive.
Definition _release2 : ident := 60%positive.
Definition _res : ident := 83%positive.
Definition _result : ident := 75%positive.
Definition _results : ident := 67%positive.
Definition _set_item : ident := 76%positive.
Definition _spawn : ident := 61%positive.
Definition _store_rel : ident := 63%positive.
Definition _surely_malloc : ident := 70%positive.
Definition _t : ident := 81%positive.
Definition _thread_locks : ident := 66%positive.
Definition _total : ident := 84%positive.
Definition _value : ident := 4%positive.
Definition _values : ident := 92%positive.
