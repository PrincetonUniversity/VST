...
Definition _idx : ident := 75%positive.
Definition _integer_hash : ident := 74%positive.
...
Definition _prev_key : ident := 78%positive.
...
Definition v_m_entries := {|
  gvar_info := (tarray (tptr (Tstruct _entry noattr)) 32);
...
Definition f_set_item := {|
  ...
  fn_temps := ((_idx, tint) :: (_e, (tptr (Tstruct _entry noattr))) ::
               ...
               (_probed_key, tint) :: (_prev_key, tint) :: (_t'4, tint) ::
      ...
      (Ssequence
        ...
        (Ssequence
          (Sset _e
            (Ederef
              (Ebinop Oadd
                (Evar _m_entries (tarray (tptr (Tstruct _entry noattr)) 32))
                        ...
                        (Ssequence
                          (Scall (Some _t'3)
                            ...
                            ((Etempvar _i (tptr tint)) ::
                             ...
                             (Etempvar _key tint) :: nil))
                          (Sset _prev_key (Etempvar _t'3 tint)))
                        (Ssequence
                          (Sifthenelse (Ebinop One (Etempvar _prev_key tint)
                                         (Econst_int (Int.repr 0) tint) tint)
                            (Sset _t'4
                              (Ecast
                                (Ebinop One (Etempvar _prev_key tint)
                                  (Etempvar _key tint) tint) tbool))
                            (Sset _t'4 (Econst_int (Int.repr 0) tint)))
                          (Sifthenelse (Etempvar _t'4 tint) Scontinue Sskip))))
                    Sskip)
                  (Ssequence
                    (Sset _i
                      (Eaddrof
