...
Module Info.
  ...
  Definition source_file := "mailbox.c"%string.
...
Definition _bufs : ident := 69%positive.
Definition _c : ident := 66%positive.
Definition _comm : ident := 71%positive.
...
Definition _reading : ident := 72%positive.
Definition _release : ident := 59%positive.
Definition _rr : ident := 78%positive.
Definition _s : ident := 65%positive.
Definition _simulate_atomic_exchange : ident := 61%positive.
...
Definition _v : ident := 96%positive.
