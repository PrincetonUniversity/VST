...
Definition _ctr : ident := 192%positive.
...
Definition _digest_len : ident := 189%positive.
Definition _done : ident := 191%positive.
...
Definition _info_len : ident := 188%positive.
...
Definition _out_key : ident := 180%positive.
...
Definition _salt : ident := 183%positive.
Definition _salt_len : ident := 184%positive.
Definition _secret : ident := 181%positive.
Definition _secret_len : ident := 182%positive.
...
Definition _todo : ident := 193%positive.
