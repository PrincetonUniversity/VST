...
(*
Definition _o_ctx : ident := 141%positive.
Definition _ctx_key : ident := 153%positive.
*)
...
Definition _ctx_key_length : ident := 1152%positive.
              ...
              (Ssequence
                ...
                (Ssequence
                  ...
                  (Ssequence
                    ...
                    (Sset _ctx_key_length (Econst_int (Int.repr 32) tint))))))
            (Ssequence
              (Scall None
              ...
              (Ssequence
                ...
                (Sset _ctx_key_length (Etempvar _len tint)))))))
      Sskip)
    (Ssequence
