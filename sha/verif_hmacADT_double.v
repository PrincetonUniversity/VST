...
replace_SEP 1 (`(initPre (Vint (Int.repr kl)) c nullval h2 key)).
  { entailer!. eapply hmacstate_PostFinal_PreInitNull; eassumption.
  }

forward_call' (c, nullval, Vint(Int.repr kl), key, kv, h2) h3. rename H into h3_init.
...
simpl in H; rename H into Round2Final. 

forward_call' (h5,c,kv). destruct H as [SCc ACc].
