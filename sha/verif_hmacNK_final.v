...
unfold hmacstate_PostFinal, hmac_relate_PostFinal. Time normalize. (*0.6*)
Exists (updShaST, (iCTX, oCTX)). 
(* Time normalize. (*17.4 SLOW*); the reason why this is slow is the type mismatch which
  we manually resolve by "change" below*)
