...
destruct (field_compatible_dec t_struct_hmac_ctx_st [StructField _o_ctx] (Vptr b0 i));
...
replace_SEP 2 `(memory_block Tsh (Int.repr (sizeof (nested_field_type2 t_struct_hmac_ctx_st [StructField _md_ctx]))) ((Vptr b0 i))).
  { entailer. 
...
(*Call SHA_Final*)
forward_call' (updSha, md, Vptr b0 i, shmd, kv).
