...
(*     assert_PROP (isptr ctxkey). entailer!. 
     ...
     { rewrite <- KL1.
       ...
       rewrite if_false. trivial. subst l64 l. clear - KL2 ge_64_l. 
       ...
       repable_signed. 
       apply Z.max_r. subst l. simpl in ge_64_l. apply typed_false_of_bool in ge_64_l. 
           clear - KL2 ge_64_l. 
           apply lt_false_inv in ge_64_l.
           rewrite Int.signed_repr in ge_64_l.
           2: rewrite int_min_signed_eq, int_max_signed_eq; omega.
     ...
     { split; auto. subst l64 l.  simpl in ge_64_l. apply typed_false_of_bool in ge_64_l. 
           clear - KL2 ge_64_l. 
           apply lt_false_inv in ge_64_l.
           rewrite Int.signed_repr in ge_64_l.
           2: rewrite int_min_signed_eq, int_max_signed_eq; omega.
     ...
     apply derives_trans with
       (Q:= data_at Tsh (Tarray tuchar (Z.of_nat (length key)) noattr)
            ...
            data_at Tsh (Tarray tuchar z0 noattr) (list_repeat n (Vint Int.zero))
     ...
     { apply sepcon_derives.
       ...
       { unfold offset_val. rewrite skipn_force_lengthn_app. 
