...
Definition _reset : ident := 65%positive.
...
Definition _HMAC_Init : ident := 69%positive.
...
Definition _pad : ident := 66%positive.
Definition _SHA256_Final : ident := 59%positive.
Definition _data : ident := 4%positive.
Definition _n : ident := 78%positive.
Definition _ctx_key : ident := 68%positive.
Definition _SHA256_Update : ident := 58%positive.
...
Definition _key : ident := 61%positive.
Definition ___builtin_fabs : ident := 11%positive.
Definition ___builtin_bswap : ident := 37%positive.
Definition _m__1 : ident := 81%positive.
Definition _key_len : ident := 76%positive.
