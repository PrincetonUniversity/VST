...
From VST.lithium Require Import programs singleton optional constrained exist.
...
Section tyfold.
  ...
  Lemma subsume_tyfold_eq A l β ls1 ls2 tys b1 b2 T :
    (default l (last ls1) ◁ₗ{β} b1 -∗ ∃ x, <affine> ⌜ls1 = ls2 x⌝ ∗
                                           (default l (last ls1) ◁ₗ{β} b2 x) ∗ T x)
  ...
  Lemma subsume_tyfold_snoc A B l β f ls1 ls2 tys (ty : B → A) b1 b2 T :
    (default l (last ls1) ◁ₗ{β} b1 -∗ ∃ x l2, <affine> ⌜ls2 x = ls1 ++ [l2]⌝ ∗
