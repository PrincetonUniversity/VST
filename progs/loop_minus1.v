...
Module Info.
  ...
  Definition source_file := "progs/loop_minus1.c"%string.
...
Definition _sumarray : ident := ltac:(string2ident "sumarray"%string).
...
(_sumarray :: ___builtin_debug :: ___builtin_nop ::
