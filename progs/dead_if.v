...
Definition _f : ident := 56%positive.
Definition _g : ident := 57%positive.
Definition _main : ident := 58%positive.
Definition _x : ident := 49%positive.
Definition _y : ident := 50%positive.
Definition _z : ident := 51%positive.
...
Definition f_f := {|
  ...
  fn_vars := nil;
  fn_temps := ((_a, tint) :: (_b, tint) :: (_c, tint) :: (_d, tint) :: nil);
  fn_body :=
(Ssequence
  (Sset _d (Econst_int (Int.repr 2) tint))
  (Ssequence
    ...
    (Ssequence
      ...
      (Ssequence
        (Sset _a
          (Ebinop Oadd (Etempvar _x tint) (Econst_int (Int.repr 1) tint)
            tint))
        (Ssequence
          (Sifthenelse (Ebinop Ogt (Etempvar _a tint)
                         (Econst_int (Int.repr 0) tint) tint)
            (Sset _b
              (Ebinop Oadd (Etempvar _x tint) (Etempvar _y tint) tint))
            (Ssequence
              (Sset _b (Etempvar _x tint))
              (Sset _c (Etempvar _z tint))))
          (Sreturn (Some (Ebinop Oadd (Etempvar _c tint) (Etempvar _b tint)
                           tint))))))))
|}.
  ...
  (Ssequence
    ...
    (Ssequence
      ...
      (Ssequence
        ...
        (Ssequence
          (Swhile
            (Ebinop Ogt (Etempvar _a tint) (Econst_int (Int.repr 0) tint)
              tint)
            (Sset _b (Etempvar _x tint)))
          (Sreturn (Some (Ebinop Oadd (Etempvar _c tint) (Etempvar _b tint)
                           tint))))))))
...
((___builtin_fabs,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_f, Gfun(Internal f_f)) :: (_g, Gfun(Internal f_g)) :: nil);
prog_public :=
