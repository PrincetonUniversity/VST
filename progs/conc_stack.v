...
Definition f_newstack := {|
  fn_return := (tptr (Tstruct _lstack noattr));
  fn_callconv := cc_default;
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_p, (tptr (Tstruct _lstack noattr))) ::
...
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
      ...
      ((Esizeof (Tstruct _lstack noattr) tuint) :: nil))
    (Sset _p
      (Ecast (Etempvar _t'1 (tptr tvoid)) (tptr (Tstruct _lstack noattr)))))
  (Ssequence
    (Sifthenelse (Eunop Onotbool
                   (Etempvar _p (tptr (Tstruct _lstack noattr))) tint)
    ...
    (Ssequence
      (Sassign
        (Efield
          (Efield
            (Ederef (Etempvar _p (tptr (Tstruct _lstack noattr)))
              (Tstruct _lstack noattr)) _d (Tstruct _stack noattr)) _top
          (tptr (Tstruct _cons noattr))) (Econst_int (Int.repr 0) tint))
      (Ssequence
        (Ssequence
          (Scall (Some _t'2)
        ...
        (Ssequence
          (Sifthenelse (Eunop Onotbool
                         (Etempvar _l (tptr (tarray (tptr tvoid) 2))) tint)
            (Scall None
              ...
              (Ssequence
                (Scall None
                  (Evar _release (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                                   cc_default))
                  ((Etempvar _l (tptr (tarray (tptr tvoid) 2))) :: nil))
                (Sreturn (Some (Etempvar _p (tptr (Tstruct _lstack noattr)))))))))))))
|}.

Definition f_push := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_p, (tptr (Tstruct _lstack noattr))) :: (_i, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_q, (tptr (Tstruct _cons noattr))) ::
               (_s, (tptr (Tstruct _stack noattr))) ::
               (_t'1, (tptr tvoid)) ::
               (_t'4, (tptr (tarray (tptr tvoid) 2))) ::
               (_t'3, (tptr (Tstruct _cons noattr))) ::
        ...
        (Ssequence
          (Sset _s
            (Eaddrof
              (Efield
                (Ederef (Etempvar _p (tptr (Tstruct _lstack noattr)))
                  (Tstruct _lstack noattr)) _d (Tstruct _stack noattr))
              ...
              (Sset _t'3
                (Efield
                  (Ederef (Etempvar _s (tptr (Tstruct _stack noattr)))
                    (Tstruct _stack noattr)) _top
                  (tptr (Tstruct _cons noattr))))
              (Sassign
                (Efield
                  (Ederef (Etempvar _q (tptr (Tstruct _cons noattr)))
                    (Tstruct _cons noattr)) _next
                  (tptr (Tstruct _cons noattr)))
                (Etempvar _t'3 (tptr (Tstruct _cons noattr)))))
            (Ssequence
              (Sassign
                (Efield
                  (Ederef (Etempvar _s (tptr (Tstruct _stack noattr)))
...
Definition f_pop := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_p, (tptr (Tstruct _lstack noattr))) :: nil);
  fn_vars := nil;
  fn_temps := ((_q, (tptr (Tstruct _cons noattr))) :: (_i, tint) ::
               (_s, (tptr (Tstruct _stack noattr))) ::
               (_t'4, (tptr (tarray (tptr tvoid) 2))) ::
               (_t'3, (tptr (tarray (tptr tvoid) 2))) ::
               (_t'2, (tptr (Tstruct _cons noattr))) ::
    ...
    (Ssequence
      (Ssequence
        (Sset _t'4
          (Efield
            (Ederef (Etempvar _p (tptr (Tstruct _lstack noattr)))
              (Tstruct _lstack noattr)) _lock (tptr (tarray (tptr tvoid) 2))))
        (Scall None
          (Evar _acquire (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                           cc_default))
          ((Etempvar _t'4 (tptr (tarray (tptr tvoid) 2))) :: nil)))
      (Ssequence
        ...
        (Ssequence
          ...
          (Ssequence
            (Sifthenelse (Eunop Onotbool
                           (Etempvar _q (tptr (Tstruct _cons noattr))) tint)
              (Ssequence
                (Ssequence
                  (Sset _t'3
                    (Efield
                  ...
                  (Scall None
                    (Evar _release (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                                     cc_default))
                    ((Etempvar _t'3 (tptr (tarray (tptr tvoid) 2))) :: nil)))
                Scontinue)
              Sskip)
            (Ssequence
              (Ssequence
...
(Composite _cons Struct
 ...
 Composite _stack Struct
   ...
   noattr ::
 Composite _lstack Struct
   ((_d, (Tstruct _stack noattr)) ::
...
(_pop :: _push :: _newstack :: _exit :: _free :: _malloc :: _release ::
 _acquire :: _makelock :: ___builtin_debug :: ___builtin_nop ::
