...
Definition ___compcert_i64_dtos : ident := 41%positive.
Definition ___compcert_i64_dtou : ident := 42%positive.
Definition ___compcert_i64_sar : ident := 53%positive.
Definition ___compcert_i64_sdiv : ident := 47%positive.
Definition ___compcert_i64_shl : ident := 51%positive.
Definition ___compcert_i64_shr : ident := 52%positive.
Definition ___compcert_i64_smod : ident := 49%positive.
Definition ___compcert_i64_smulh : ident := 54%positive.
Definition ___compcert_i64_stod : ident := 43%positive.
Definition ___compcert_i64_stof : ident := 45%positive.
Definition ___compcert_i64_udiv : ident := 48%positive.
Definition ___compcert_i64_umod : ident := 50%positive.
Definition ___compcert_i64_umulh : ident := 55%positive.
Definition ___compcert_i64_utod : ident := 44%positive.
Definition ___compcert_i64_utof : ident := 46%positive.
...
Definition _colU : ident := 97%positive.
...
Definition _fancy_reset : ident := 79%positive.
Definition _fancyfoo_methods : ident := 81%positive.
Definition _fancyfoo_object : ident := 13%positive.
Definition _fancymethods : ident := 11%positive.
Definition _foo_methods : ident := 76%positive.
Definition _foo_object : ident := 8%positive.
Definition _foo_reset : ident := 70%positive.
Definition _foo_twiddle : ident := 73%positive.
Definition _foo_twiddleR : ident := 75%positive.
Definition _getcolor : ident := 10%positive.
Definition _i : ident := 71%positive.
Definition _main : ident := 98%positive.
Definition _make_fancyfoo : ident := 82%positive.
Definition _make_fancyfooTyped : ident := 83%positive.
Definition _make_foo : ident := 78%positive.
...
Definition _p : ident := 77%positive.
Definition _p_reset : ident := 85%positive.
Definition _p_twiddle : ident := 86%positive.
Definition _pmtable : ident := 84%positive.
Definition _q : ident := 87%positive.
Definition _q_getcolor : ident := 91%positive.
Definition _q_reset : ident := 89%positive.
Definition _q_setcolor : ident := 90%positive.
Definition _qmtable : ident := 88%positive.
Definition _reset : ident := 2%positive.
Definition _s_reset : ident := 74%positive.
Definition _self : ident := 69%positive.
...
Definition _u_getcolor : ident := 96%positive.
Definition _u_reset : ident := 95%positive.
Definition _umtable : ident := 94%positive.
