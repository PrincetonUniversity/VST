...
Definition ___stringlit_1 : ident := 57%positive.
Definition _f : ident := 55%positive.
Definition _fac : ident := 56%positive.
...
Definition f_fac := {|
  ...
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (_f, tint) :: (_t'2, tint) :: (_t'1, tint) ::
               nil);
  fn_body :=
(Ssequence
  (Ssequence
  ...
  (Ssequence
    (Swhile
      ...
      (Ssequence
        ...
        (Sset _f (Ebinop Omul (Etempvar _f tint) (Etempvar _t'2 tint) tint))))
  ...
  (Ssequence
    (Ssequence
      ...
      (Scall None
        ...
        ((Evar ___stringlit_1 (tarray tschar 4)) :: (Etempvar _t'1 tint) ::
         nil)))
...
prog_public :=
(_main :: _fac :: _printf :: ___builtin_debug :: ___builtin_nop ::
