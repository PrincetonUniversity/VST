...
Module Info.
  ...
  Definition source_file := "progs/objectSelfFancy.c"%string.
...
Definition _col : ident := 90%positive.
Definition _colU : ident := 95%positive.
...
Definition _fancyfoo_methods : ident := 79%positive.
...
Definition _make_fancyfoo : ident := 80%positive.
Definition _make_fancyfooTyped : ident := 81%positive.
...
Definition _p_reset : ident := 83%positive.
Definition _p_twiddle : ident := 84%positive.
Definition _pmtable : ident := 82%positive.
Definition _q : ident := 85%positive.
Definition _q_getcolor : ident := 89%positive.
Definition _q_reset : ident := 87%positive.
Definition _q_setcolor : ident := 88%positive.
Definition _qmtable : ident := 86%positive.
...
Definition _u_getcolor : ident := 94%positive.
Definition _u_reset : ident := 93%positive.
Definition _umtable : ident := 92%positive.
