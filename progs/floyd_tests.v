...
Module Info.
  ...
  Definition source_file := "progs/floyd_tests.c"%string.
...
Definition _test_sizeof : ident := ltac:(string2ident "test_sizeof"%string).
...
Definition f_test_sizeof := {|
  ...
  fn_body :=
(Ssequence
  (Sset _a (Esizeof tint tuint))
  (Ssequence
    (Sset _b
      (Ebinop Oadd (Econst_int (Int.repr 1) tint) (Esizeof tint tuint) tuint))
...
(_main :: _test_sizeof :: ___builtin_debug :: ___builtin_nop ::
