...
Module Info.
  ...
  Definition source_file := "progs/peel.c"%string.
    ...
    (Sloop
      (Ssequence
        (Sifthenelse (Ebinop Ogt
                       (Ebinop Omul (Etempvar _i tint) (Etempvar _i tint)
                         tint) (Etempvar _b tint) tint)
          Sskip
          Sbreak)
        (Sset _a (Etempvar _i tint)))
      (Sset _i
