...
Module Info.
  ...
  Definition source_file := "progs/dotprod.c".
...
Definition _dotprod : ident := 61%positive.
...
Definition _z : ident := 56%positive.
...
(_dotprod :: _add :: ___builtin_debug :: ___builtin_write32_reversed ::
