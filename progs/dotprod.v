...
Definition _z : ident := 32%positive.
...
Definition _sum : ident := 36%positive.
Definition _y : ident := 31%positive.
...
Definition _dotprod : ident := 37%positive.
...
Definition _add : ident := 34%positive.
Definition ___builtin_read32_reversed : ident := 29%positive.
Definition _n : ident := 35%positive.
Definition _x : ident := 30%positive.
...
Definition f_dotprod := {|
  ...
  fn_body :=
(Ssequence
  (Sset _sum (Econst_float (Float.double_of_bits (Int64.repr 0)) tdouble))
  (Ssequence
    (Ssequence
      (Sset _i (Econst_int (Int.repr 0) tint))
      (Sloop
