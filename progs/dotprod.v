...
Module Info.
  ...
  Definition source_file := "progs/dotprod.c"%string.
...
Definition _add : ident := ltac:(string2ident "add"%string).
Definition _dotprod : ident := ltac:(string2ident "dotprod"%string).
Definition _i : ident := 3%positive.
Definition _main : ident := 4%positive.
Definition _n : ident := 5%positive.
Definition _sum : ident := 6%positive.
Definition _x : ident := 7%positive.
Definition _y : ident := 8%positive.
Definition _z : ident := 9%positive.
Definition _t'1 : ident := 10%positive.
Definition _t'2 : ident := 11%positive.
...
Definition f_dotprod := {|
  ...
  fn_params := ((_n, tint) :: (_x, (tptr tdouble)) :: (_y, (tptr tdouble)) ::
                nil);
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (_sum, tdouble) :: (_t'2, tdouble) ::
               (_t'1, tdouble) :: nil);
  fn_body :=
(Ssequence
...
(_dotprod :: _add :: ___builtin_debug :: ___builtin_nop ::
