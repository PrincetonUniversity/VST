...
Definition _c : ident := 3%positive.
Definition _d : ident := 4%positive.
Definition _d1 : ident := 5%positive.
Definition _d2 : ident := 6%positive.
Definition _dest : ident := 7%positive.
Definition _i : ident := 8%positive.
Definition _j : ident := 9%positive.
Definition _main : ident := 10%positive.
Definition _src : ident := 11%positive.
Definition _str : ident := 12%positive.
Definition _str1 : ident := 13%positive.
Definition _str2 : ident := 14%positive.
Definition _strcat : ident := ltac:(string2ident "strcat"%string).
Definition _strchr : ident := ltac:(string2ident "strchr"%string).
Definition _strcmp : ident := ltac:(string2ident "strcmp"%string).
Definition _strcpy : ident := ltac:(string2ident "strcpy"%string).
Definition _strlen : ident := ltac:(string2ident "strlen"%string).
