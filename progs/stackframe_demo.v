...
Module Info.
  ...
  Definition source_file := "progs/stackframe_demo.c".
...
Definition f_iden := {|
  ...
  fn_body :=
(Ssequence
  (Sassign (Evar _y tint) (Etempvar _x tint))
  (Ssequence
    (Sset _p (Eaddrof (Evar _y tint) (tptr tint)))
    (Ssequence
...
(_main :: _iden :: ___builtin_debug :: ___builtin_write32_reversed ::
