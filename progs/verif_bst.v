...
Lemma subsume_insert:
 subsume_funspec_weak (snd insert_spec) (snd abs_insert_spec).
Proof.
...
Lemma subsume_treebox_new:
 subsume_funspec_weak (snd treebox_new_spec) (snd abs_treebox_new_spec).
Proof.
apply NDsubsume_subsume.
split; reflexivity.
split3; auto.
...
Lemma subsume_treebox_free:
 subsume_funspec_weak (snd treebox_free_spec) (snd abs_treebox_free_spec).
Proof.
apply NDsubsume_subsume.
split; reflexivity.
split3; auto.
