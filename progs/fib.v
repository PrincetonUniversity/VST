...
Definition _fib_loop : ident := $"fib_loop".
Definition _fib_loop_mod : ident := $"fib_loop_mod".
Definition _fib_loop_save_var : ident := $"fib_loop_save_var".
Definition _fib_rec : ident := $"fib_rec".
Definition _i : ident := $"i".
Definition _main : ident := $"main".
Definition _mod : ident := $"mod".
Definition _n : ident := $"n".
Definition _swap_int : ident := $"swap_int".
