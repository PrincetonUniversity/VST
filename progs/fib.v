...
Definition _a0 : ident := 4%positive.
Definition _a1 : ident := 5%positive.
Definition _a2 : ident := 6%positive.
Definition _b : ident := 7%positive.
Definition _fib_loop : ident := ltac:(string2ident "fib_loop"%string).
Definition _fib_loop_mod : ident := ltac:(string2ident "fib_loop_mod"%string).
Definition _fib_loop_save_var : ident := ltac:(string2ident "fib_loop_save_var"%string).
Definition _fib_rec : ident := ltac:(string2ident "fib_rec"%string).
Definition _i : ident := 8%positive.
Definition _main : ident := ltac:(string2ident "main"%string).
Definition _mod : ident := 9%positive.
Definition _n : ident := 10%positive.
Definition _swap_int : ident := ltac:(string2ident "swap_int"%string).
