...
Definition _a : ident := 66%positive.
Definition _a0 : ident := 55%positive.
Definition _a1 : ident := 56%positive.
Definition _a2 : ident := 57%positive.
Definition _b : ident := 67%positive.
Definition _fib_loop : ident := 59%positive.
Definition _fib_loop_mod : ident := 62%positive.
Definition _fib_loop_save_var : ident := 60%positive.
Definition _fib_rec : ident := 63%positive.
Definition _i : ident := 58%positive.
Definition _main : ident := 69%positive.
Definition _mod : ident := 61%positive.
Definition _n : ident := 54%positive.
Definition _swap_int : ident := 68%positive.
Definition _x : ident := 64%positive.
Definition _y : ident := 65%positive.
