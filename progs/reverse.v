...
Module Info.
  ...
  Definition source_file := "progs/reverse.c".
...
Definition _reverse : ident := 65%positive.
Definition _s : ident := 59%positive.
Definition _sumlist : ident := 62%positive.
Definition _t : ident := 60%positive.
Definition _tail : ident := 3%positive.
Definition _three : ident := 57%positive.
Definition _v : ident := 64%positive.
Definition _w : ident := 63%positive.
