...
Definition _h : ident := 3%positive.
...
Definition _p : ident := 5%positive.
Definition _r : ident := 6%positive.
Definition _reverse : ident := ltac:(string2ident "reverse"%string).
Definition _s : ident := 7%positive.
Definition _sumlist : ident := ltac:(string2ident "sumlist"%string).
Definition _t : ident := 8%positive.
Definition _tail : ident := 9%positive.
Definition _three : ident := ltac:(string2ident "three"%string).
Definition _v : ident := 10%positive.
