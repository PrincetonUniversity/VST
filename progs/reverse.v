...
Definition _three : ident := 50%positive.
...
Definition _r : ident := 59%positive.
Definition ___builtin_bswap32 : ident := 37%positive.
Definition ___builtin_addl : ident := 4%positive.
Definition _reverse : ident := 58%positive.
...
Definition _sumlist : ident := 55%positive.
...
Definition f_main := {|
  ...
  fn_temps := ((_r, (tptr (Tstruct _list noattr))) :: (_s, tint) ::
               (62%positive, tint) ::
               (61%positive, (tptr (Tstruct _list noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    ...
    (Sset _r (Etempvar 61%positive (tptr (Tstruct _list noattr)))))
  (Ssequence
    (Ssequence
      ...
      (Sset _s (Etempvar 62%positive tint)))
    (Sreturn (Some (Etempvar _s tint)))))
|}.
