...
Definition _s : ident := 38%positive.
...
Definition _three : ident := 36%positive.
...
Definition _t : ident := 39%positive.
...
Definition _w : ident := 42%positive.
...
Definition _sumlist : ident := 41%positive.
...
Definition _r' : ident := 47%positive.
