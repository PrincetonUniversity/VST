...
Definition _fifo_empty : ident := 72%positive.
Definition _fifo_get : ident := 73%positive.
Definition _fifo_new : ident := 68%positive.
Definition _fifo_put : ident := 71%positive.
...
Definition _make_elem : ident := 74%positive.
...
Definition _surely_malloc : ident := 66%positive.
