...
(Ssequence
  (Ssequence
    ...
    (Sset _p (Etempvar 138%positive (tptr tvoid))))
  (Ssequence
    (Sassign
      (Efield
        (Ederef (Etempvar _p (tptr (Tstruct _elem noattr)))
...
Definition f_main := {|
  ...
  fn_temps := ((_i, tint) :: (_j, tint) ::
               ...
               (142%positive, (tptr (Tstruct _elem noattr))) ::
               (141%positive, (tptr (Tstruct _elem noattr))) ::
               (140%positive, (tptr (Tstruct _elem noattr))) ::
               (139%positive, (tptr (Tstruct _fifo noattr))) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
      (Scall (Some 139%positive)
        (Evar _fifo_new (Tfunction Tnil (tptr (Tstruct _fifo noattr))
                          cc_default)) nil)
      (Sset _Q (Etempvar 139%positive (tptr (Tstruct _fifo noattr)))))
    (Ssequence
      (Ssequence
        ...
        (Sset _p (Etempvar 140%positive (tptr (Tstruct _elem noattr)))))
      (Ssequence
        (Scall None
        ...
        (Ssequence
          (Ssequence
            ...
            (Sset _p (Etempvar 141%positive (tptr (Tstruct _elem noattr)))))
          (Ssequence
            (Scall None
              (Evar _fifo_put (Tfunction
                                (Tcons (tptr (Tstruct _fifo noattr))
            ...
            (Ssequence
              (Ssequence
                ...
                (Sset _p
                  (Etempvar 142%positive (tptr (Tstruct _elem noattr)))))
              (Ssequence
                (Sset _i
                  (Efield
                    (Ederef (Etempvar _p (tptr (Tstruct _elem noattr)))
