...
Definition __l : ident := 72%positive.
Definition _b : ident := 66%positive.
Definition _delete : ident := 79%positive.
...
Definition _turn_left : ident := 76%positive.
