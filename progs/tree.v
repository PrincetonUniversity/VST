...
Definition _Xfoo : ident := 72%positive.
Definition _Xnode : ident := 4%positive.
Definition _Xnode_add : ident := 68%positive.
Definition _YList : ident := 7%positive.
Definition _YList_add : ident := 69%positive.
Definition _YTree_add : ident := 71%positive.
Definition _Ynode : ident := 8%positive.
Definition _Ynode_add : ident := 70%positive.
...
Definition ___compcert_i64_dtos : ident := 40%positive.
Definition ___compcert_i64_dtou : ident := 41%positive.
Definition ___compcert_i64_sar : ident := 52%positive.
Definition ___compcert_i64_sdiv : ident := 46%positive.
Definition ___compcert_i64_shl : ident := 50%positive.
Definition ___compcert_i64_shr : ident := 51%positive.
Definition ___compcert_i64_smod : ident := 48%positive.
Definition ___compcert_i64_smulh : ident := 53%positive.
Definition ___compcert_i64_stod : ident := 42%positive.
Definition ___compcert_i64_stof : ident := 44%positive.
Definition ___compcert_i64_udiv : ident := 47%positive.
Definition ___compcert_i64_umod : ident := 49%positive.
Definition ___compcert_i64_umulh : ident := 54%positive.
Definition ___compcert_i64_utod : ident := 43%positive.
Definition ___compcert_i64_utof : ident := 45%positive.
Definition ___compcert_va_composite : ident := 39%positive.
Definition ___compcert_va_float64 : ident := 38%positive.
Definition ___compcert_va_int32 : ident := 36%positive.
Definition ___compcert_va_int64 : ident := 37%positive.
