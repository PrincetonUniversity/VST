...
Definition _BinaryTree : ident := $"BinaryTree".
Definition _XList : ident := $"XList".
Definition _Xfoo : ident := $"Xfoo".
Definition _Xnode : ident := $"Xnode".
Definition _Xnode_add : ident := $"Xnode_add".
Definition _YList : ident := $"YList".
Definition _YList_add : ident := $"YList_add".
Definition _YTree_add : ident := $"YTree_add".
Definition _Ynode : ident := $"Ynode".
Definition _Ynode_add : ident := $"Ynode_add".
