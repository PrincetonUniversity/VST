...
Module Info.
  ...
  Definition source_file := "progs/objectSelf.c".
...
Definition _foo_methods : ident := 71%positive.
Definition _foo_object : ident := 8%positive.
Definition _foo_reset : ident := 65%positive.
Definition _foo_twiddle : ident := 68%positive.
Definition _foo_twiddleR : ident := 70%positive.
Definition _i : ident := 66%positive.
Definition _main : ident := 76%positive.
Definition _make_foo : ident := 73%positive.
...
Definition _p_reset : ident := 74%positive.
Definition _p_twiddle : ident := 75%positive.
Definition _reset : ident := 2%positive.
Definition _s_reset : ident := 69%positive.
Definition _self : ident := 64%positive.
