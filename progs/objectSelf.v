...
Module Info.
  ...
  Definition source_file := "progs/objectSelf.c"%string.
...
Definition _foo_methods : ident := 70%positive.
Definition _foo_object : ident := 8%positive.
Definition _foo_reset : ident := 64%positive.
Definition _foo_twiddle : ident := 67%positive.
Definition _foo_twiddleR : ident := 69%positive.
Definition _i : ident := 65%positive.
Definition _main : ident := 75%positive.
Definition _make_foo : ident := 72%positive.
...
Definition _p_reset : ident := 73%positive.
Definition _p_twiddle : ident := 74%positive.
Definition _reset : ident := 2%positive.
Definition _s_reset : ident := 68%positive.
Definition _self : ident := 63%positive.
...
(_main :: _make_foo :: _foo_methods :: _foo_twiddleR :: _foo_twiddle ::
 _foo_reset :: _exit :: _malloc :: ___builtin_debug ::
