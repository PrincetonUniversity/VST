...
Definition __133 : ident := 3%positive.
...
Definition _fabs_single : ident := 57%positive.
Definition _i : ident := 2%positive.
Definition _main : ident := 58%positive.
Definition _u : ident := 56%positive.
...
Definition f_fabs_single := {|
  ...
  fn_vars := ((_u, (Tunion __133 noattr)) :: nil);
  fn_temps := ((_t'2, tuint) :: (_t'1, tfloat) :: nil);
  fn_body :=
(Ssequence
  (Sassign (Efield (Evar _u (Tunion __133 noattr)) _f tfloat)
    (Etempvar _x tfloat))
  (Ssequence
    (Ssequence
      (Sset _t'2 (Efield (Evar _u (Tunion __133 noattr)) _i tuint))
      (Sassign (Efield (Evar _u (Tunion __133 noattr)) _i tuint)
        (Ebinop Oand (Etempvar _t'2 tuint)
          (Econst_int (Int.repr 2147483647) tint) tuint)))
    (Ssequence
      (Sset _t'1 (Efield (Evar _u (Tunion __133 noattr)) _f tfloat))
