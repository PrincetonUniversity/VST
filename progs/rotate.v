...
Module Info.
  ...
  Definition source_file := "progs/rotate.c"%string.
...
Definition _i__1 : ident := 61%positive.
Definition _i__2 : ident := 62%positive.
Definition _k : ident := 58%positive.
Definition _main : ident := 66%positive.
Definition _malloc : ident := 53%positive.
Definition _n : ident := 57%positive.
Definition _rotate : ident := 63%positive.
Definition _sorted_rotate : ident := 65%positive.
  ...
  (Ssequence
    ...
    (Ssequence
      ...
      (Ssequence
        (Ssequence
          (Sset _i__1
            (Ebinop Osub (Etempvar _n tint) (Etempvar _k tint) tint))
          (Sloop
            (Ssequence
...
(_sorted_rotate :: _rotate :: _exit :: _free :: _malloc ::
