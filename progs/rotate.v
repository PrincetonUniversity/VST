...
Module Info.
  ...
  Definition source_file := "progs/rotate.c".
...
Definition _i__1 : ident := 62%positive.
Definition _i__2 : ident := 63%positive.
...
Definition _rotate : ident := 64%positive.
Definition _sorted_rotate : ident := 66%positive.
