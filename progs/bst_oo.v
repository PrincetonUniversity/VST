...
Definition ___stringlit_1 : ident := 3%positive.
Definition ___stringlit_2 : ident := 4%positive.
Definition ___stringlit_3 : ident := 5%positive.
Definition ___stringlit_4 : ident := 6%positive.
Definition __l : ident := 7%positive.
Definition _b : ident := 8%positive.
Definition _delete : ident := ltac:(string2ident "delete"%string).
Definition _freeN : ident := ltac:(string2ident "freeN"%string).
Definition _get : ident := ltac:(string2ident "get"%string).
Definition _key : ident := 9%positive.
Definition _l : ident := 10%positive.
Definition _left : ident := 11%positive.
Definition _main : ident := ltac:(string2ident "main"%string).
Definition _mallocN : ident := ltac:(string2ident "mallocN"%string).
Definition _mid : ident := 12%positive.
Definition _p : ident := 13%positive.
Definition _pa : ident := 14%positive.
Definition _pb : ident := 15%positive.
Definition _pushdown_left : ident := ltac:(string2ident "pushdown_left"%string).
Definition _q : ident := 16%positive.
Definition _r : ident := 17%positive.
Definition _right : ident := 18%positive.
Definition _set : ident := ltac:(string2ident "set"%string).
Definition _subscr : ident := ltac:(string2ident "subscr"%string).
Definition _t : ident := 19%positive.
Definition _tree : ident := ltac:(string2ident "tree"%string).
Definition _tree_free : ident := ltac:(string2ident "tree_free"%string).
Definition _treebox_free : ident := ltac:(string2ident "treebox_free"%string).
Definition _treebox_new : ident := ltac:(string2ident "treebox_new"%string).
Definition _turn_left : ident := ltac:(string2ident "turn_left"%string).
Definition _v : ident := 20%positive.
Definition _value : ident := 21%positive.
Definition _x : ident := 22%positive.
Definition _y : ident := 23%positive.
Definition _t'1 : ident := 24%positive.
