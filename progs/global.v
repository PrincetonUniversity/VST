...
Module Info.
  ...
  Definition source_file := "progs/global.c".
...
Definition _e : ident := 61%positive.
Definition _f : ident := 62%positive.
Definition _foo : ident := 3%positive.
Definition _g : ident := 63%positive.
Definition _h : ident := 64%positive.
