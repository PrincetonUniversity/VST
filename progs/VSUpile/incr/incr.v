...
Module Info.
  ...
  Definition source_file := "incr/incr.c".
...
Definition _auxdata : ident := 57%positive.
Definition _global_auxdata : ident := 60%positive.
Definition _i : ident := 56%positive.
Definition _incr1 : ident := 58%positive.
Definition _incr2 : ident := 59%positive.
Definition _incr3 : ident := 61%positive.
Definition _incr4 : ident := 62%positive.
