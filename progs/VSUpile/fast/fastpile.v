...
Definition _Apile_add : ident := 62%positive.
Definition _Apile_count : ident := 63%positive.
Definition _Onepile_add : ident := 68%positive.
Definition _Onepile_count : ident := 69%positive.
Definition _Onepile_init : ident := 67%positive.
Definition _Pile_add : ident := 59%positive.
Definition _Pile_count : ident := 60%positive.
Definition _Pile_free : ident := 78%positive.
...
Definition _a_pile : ident := 61%positive.
...
Definition _placeholder : ident := 79%positive.
...
Definition _the_pile : ident := 66%positive.
