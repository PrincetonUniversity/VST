...
Definition _Apile_add : ident := 74%positive.
Definition _Apile_count : ident := 75%positive.
Definition _Onepile_add : ident := 78%positive.
Definition _Onepile_count : ident := 79%positive.
Definition _Onepile_init : ident := 77%positive.
Definition _Pile_add : ident := 67%positive.
Definition _Pile_count : ident := 70%positive.
Definition _Pile_free : ident := 72%positive.
Definition _Pile_new : ident := 66%positive.
...
Definition _a_pile : ident := 73%positive.
...
Definition _head : ident := 62%positive.
Definition _i : ident := 80%positive.
Definition _list : ident := 60%positive.
Definition _main : ident := 58%positive.
Definition _malloc : ident := 54%positive.
Definition _n : ident := 59%positive.
Definition _next : ident := 61%positive.
Definition _p : ident := 64%positive.
Definition _pile : ident := 63%positive.
Definition _placeholder : ident := 57%positive.
Definition _pp : ident := 86%positive.
Definition _q : ident := 68%positive.
Definition _r : ident := 71%positive.
Definition _s : ident := 87%positive.
Definition _sum : ident := 85%positive.
Definition _surely_malloc : ident := 65%positive.
Definition _the_pile : ident := 76%positive.
