...
Module Info.
  ...
  Definition source_file := "progs/cast_test.c"%string.
...
Definition _d : ident := 5%positive.
Definition _main : ident := 6%positive.
Definition _n : ident := 7%positive.
Definition _test : ident := ltac:(string2ident "test"%string).
...
(_test :: ___builtin_debug :: ___builtin_nop ::
