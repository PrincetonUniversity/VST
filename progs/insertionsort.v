...
Definition _guard : ident := 3%positive.
Definition _head : ident := 4%positive.
Definition _index : ident := 5%positive.
Definition _insert : ident := ltac:(string2ident "insert"%string).
Definition _insert_node : ident := 6%positive.
Definition _insert_value : ident := 7%positive.
Definition _insertionsort : ident := ltac:(string2ident "insertionsort"%string).
Definition _list : ident := ltac:(string2ident "list"%string).
...
Definition _sorted : ident := 11%positive.
Definition _sortedvalue : ident := 12%positive.
Definition _tail : ident := 13%positive.
Definition _t'1 : ident := 14%positive.
Definition _t'2 : ident := 15%positive.
