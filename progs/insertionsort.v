...
Definition _guard : ident := 57%positive.
Definition _head : ident := 1%positive.
Definition _index : ident := 54%positive.
Definition _insert : ident := 59%positive.
Definition _insert_node : ident := 52%positive.
Definition _insert_value : ident := 58%positive.
Definition _insertionsort : ident := 62%positive.
...
Definition _previous : ident := 55%positive.
Definition _sorted : ident := 53%positive.
Definition _sortedvalue : ident := 56%positive.
