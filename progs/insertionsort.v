...
Definition _guard : ident := $"guard".
Definition _head : ident := $"head".
Definition _index : ident := $"index".
Definition _insert : ident := $"insert".
Definition _insert_node : ident := $"insert_node".
Definition _insert_value : ident := $"insert_value".
Definition _insertionsort : ident := $"insertionsort".
Definition _list : ident := $"list".
Definition _main : ident := $"main".
Definition _next : ident := $"next".
Definition _p : ident := $"p".
Definition _previous : ident := $"previous".
Definition _sorted : ident := $"sorted".
Definition _sortedvalue : ident := $"sortedvalue".
