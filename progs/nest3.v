...
Definition _get : ident := 71%positive.
Definition _i : ident := 70%positive.
Definition _main : ident := 75%positive.
Definition _multi_command : ident := 73%positive.
Definition _multi_command_s : ident := 74%positive.
Definition _p : ident := 61%positive.
Definition _p0 : ident := 62%positive.
Definition _p1 : ident := 63%positive.
Definition _p2 : ident := 64%positive.
Definition _p3 : ident := 65%positive.
Definition _p4 : ident := 66%positive.
Definition _p5 : ident := 67%positive.
Definition _p6 : ident := 68%positive.
Definition _p7 : ident := 69%positive.
