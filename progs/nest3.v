...
Definition _a : ident := ltac:(string2ident "a"%string).
Definition _b : ident := ltac:(string2ident "b"%string).
Definition _c : ident := ltac:(string2ident "c"%string).
Definition _get : ident := ltac:(string2ident "get"%string).
Definition _i : ident := 3%positive.
Definition _main : ident := 4%positive.
Definition _multi_command : ident := ltac:(string2ident "multi_command"%string).
Definition _multi_command_s : ident := ltac:(string2ident "multi_command_s"%string).
Definition _p : ident := ltac:(string2ident "p"%string).
Definition _p0 : ident := ltac:(string2ident "p0"%string).
Definition _p1 : ident := ltac:(string2ident "p1"%string).
Definition _p2 : ident := ltac:(string2ident "p2"%string).
Definition _p3 : ident := ltac:(string2ident "p3"%string).
Definition _p4 : ident := ltac:(string2ident "p4"%string).
Definition _p5 : ident := ltac:(string2ident "p5"%string).
Definition _p6 : ident := ltac:(string2ident "p6"%string).
Definition _p7 : ident := ltac:(string2ident "p7"%string).
Definition _set : ident := ltac:(string2ident "set"%string).
Definition _x1 : ident := 5%positive.
Definition _x2 : ident := 6%positive.
Definition _y1 : ident := 7%positive.
Definition _y2 : ident := 8%positive.
Definition _z1 : ident := 9%positive.
Definition _z2 : ident := 10%positive.
