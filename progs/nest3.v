...
Definition _get : ident := 68%positive.
Definition _i : ident := 67%positive.
Definition _main : ident := 72%positive.
Definition _multi_command : ident := 70%positive.
Definition _multi_command_s : ident := 71%positive.
Definition _p : ident := 58%positive.
Definition _p0 : ident := 59%positive.
Definition _p1 : ident := 60%positive.
Definition _p2 : ident := 61%positive.
Definition _p3 : ident := 62%positive.
Definition _p4 : ident := 63%positive.
Definition _p5 : ident := 64%positive.
Definition _p6 : ident := 65%positive.
Definition _p7 : ident := 66%positive.
Definition _set : ident := 69%positive.
