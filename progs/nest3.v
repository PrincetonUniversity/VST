...
Definition _struct_a : ident := 32%positive.
Definition ___compcert_va_int64 : ident := 16%positive.
Definition _struct_c : ident := 38%positive.
...
Definition _z2 : ident := 36%positive.
Definition _x1 : ident := 31%positive.
...
Definition _z1 : ident := 37%positive.
