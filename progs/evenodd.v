...
Definition _odd : ident := 32%positive.
...
Definition _even : ident := 31%positive.
...
Definition _main : ident := 33%positive.
...
Definition _n : ident := 30%positive.
  ...
  (Ssequence
    (Scall (Some 34%positive)
      ...
      ((Ebinop Osub (Etempvar _n tuint) (Econst_int (Int.repr 1) tint) tuint) ::
       nil))
    (Sreturn (Some (Etempvar 34%positive tint)))))
|}.
...
((___builtin_fabs,
 ...
 (___builtin_write32_reversed,
   Gfun(External (EF_builtin ___builtin_write32_reversed
     ...
     tvoid cc_default)) :: (_odd, Gfun(Internal f_odd)) ::
