...
Module Info.
  ...
  Definition source_file := "progs/io.c".
...
Definition _getchar : ident := 54%positive.
Definition _getchar_blocking : ident := 57%positive.
...
Definition _putchar_blocking : ident := 59%positive.
