...
Definition _getchar_blocking : ident := 55%positive.
Definition _i : ident := 58%positive.
Definition _main : ident := 64%positive.
Definition _n : ident := 62%positive.
Definition _print_int : ident := 61%positive.
Definition _print_intr : ident := 60%positive.
Definition _putchar : ident := 53%positive.
Definition _putchar_blocking : ident := 57%positive.
