...
Definition _ctr : ident := ltac:(string2ident "ctr"%string).
Definition _ctr_lock : ident := ltac:(string2ident "ctr_lock"%string).
...
Definition _incr : ident := ltac:(string2ident "incr"%string).
Definition _l : ident := 4%positive.
Definition _lockc : ident := 5%positive.
Definition _lockt : ident := 6%positive.
Definition _main : ident := ltac:(string2ident "main"%string).
Definition _makelock : ident := ltac:(string2ident "makelock"%string).
Definition _read : ident := ltac:(string2ident "read"%string).
...
Definition _thread_lock : ident := ltac:(string2ident "thread_lock"%string).
