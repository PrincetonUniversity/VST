...
Module Info.
  ...
  Definition source_file := "progs/float.c"%string.
...
(Composite _foo Struct
   ((_x, tint) :: (_y, tfloat) :: (_z, tdouble) :: nil)
   noattr :: nil).
...
(_main :: _s :: ___builtin_debug :: ___builtin_nop ::
