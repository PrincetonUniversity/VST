...
Definition _x : ident := 32%positive.
...
Definition _x1 : ident := 36%positive.
...
Definition _y2 : ident := 37%positive.
...
Definition _struct_foo : ident := 33%positive.
...
Definition _y1 : ident := 35%positive.
Definition _z : ident := 30%positive.
