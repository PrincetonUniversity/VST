...
Module Info.
  ...
  Definition source_file := "progs/object.c".
...
Definition _foo_methods : ident := 68%positive.
...
Definition _make_foo : ident := 70%positive.
...
Definition _p_reset : ident := 71%positive.
Definition _p_twiddle : ident := 72%positive.
