...
Definition _foo_methods : ident := 63%positive.
Definition _foo_object : ident := 7%positive.
Definition _foo_reset : ident := 59%positive.
Definition _foo_twiddle : ident := 62%positive.
Definition _i : ident := 60%positive.
Definition _main : ident := 68%positive.
Definition _make_foo : ident := 65%positive.
...
Definition _p_reset : ident := 66%positive.
Definition _p_twiddle : ident := 67%positive.
Definition _reset : ident := 2%positive.
Definition _self : ident := 58%positive.
