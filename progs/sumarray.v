...
Definition _s : ident := 49%positive.
...
Definition _four : ident := 52%positive.
...
Definition _sumarray : ident := 51%positive.
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_s, tint) :: (54%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    ...
    (Sset _s (Etempvar 54%positive tint)))
  (Sreturn (Some (Etempvar _s tint))))
|}.
...
prog_public :=
(_main :: _four :: _sumarray :: ___builtin_write32_reversed ::
