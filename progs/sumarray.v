...
Definition _make_elem : ident := 136%positive.
Definition _temp : ident := 85%positive.
Definition _p1 : ident := 110%positive.
Definition _n1 : ident := 148%positive.
Definition _w : ident := 143%positive.
Definition _hi : ident := 138%positive.
Definition _fifo_new : ident := 130%positive.
Definition _p2 : ident := 111%positive.
Definition ___i64_smod : ident := 22%positive.
Definition _lo : ident := 137%positive.
Definition ___compcert_va_float64 : ident := 12%positive.
Definition _freeN : ident := 128%positive.
...
Definition _strcspn_kmp : ident := 150%positive.
...
Definition _sumlist : ident := 142%positive.
...
Definition _fifo_get : ident := 135%positive.
Definition _three : ident := 141%positive.
...
Definition _Q : ident := 129%positive.
...
Definition _fifo_put : ident := 133%positive.
Definition ___builtin_write32_reversed : ident := 42%positive.
Definition _t : ident := 132%positive.
...
Definition _s2 : ident := 147%positive.
...
Definition _sumarray : ident := 151%positive.
Definition _s1 : ident := 146%positive.
Definition _elem : ident := 125%positive.
...
Definition _reverse : ident := 139%positive.
...
Definition _fifo : ident := 126%positive.
...
Definition _r : ident := 145%positive.
Definition _v : ident := 144%positive.
Definition _va : ident := 86%positive.
Definition ___builtin_va_end : ident := 9%positive.
Definition _h : ident := 131%positive.
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_s, tint) :: (152%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
      (Scall (Some 152%positive)
        ...
        ((Evar _four (tarray tint 4)) :: (Econst_int (Int.repr 4) tint) ::
         nil))
      (Sset _s (Etempvar 152%positive tint)))
    (Sreturn (Some (Etempvar _s tint))))
