...
Definition _LG_bump : ident := $"LG_bump".
Definition _LG_foo : ident := $"LG_foo".
Definition _LG_get : ident := $"LG_get".
Definition _LG_init : ident := $"LG_init".
Definition _LG_n : ident := $"LG_n".
...
Definition _client_var : ident := $"client_var".
Definition _foo : ident := $"foo".
Definition _i : ident := $"i".
Definition _initialized : ident := $"initialized".
