...
Definition _a : ident := 80%positive.
Definition _arena : ident := 66%positive.
Definition _b : ident := 81%positive.
Definition _copytree : ident := 76%positive.
Definition _depth : ident := 69%positive.
Definition _exit : ident := 58%positive.
Definition _i : ident := 77%positive.
Definition _int_or_ptr_to_int : ident := 61%positive.
Definition _int_or_ptr_to_ptr : ident := 62%positive.
Definition _int_to_int_or_ptr : ident := 63%positive.
Definition _leaf : ident := 65%positive.
Definition _left : ident := 1%positive.
Definition _main : ident := 83%positive.
Definition _makenode : ident := 68%positive.
Definition _maketree : ident := 73%positive.
Definition _next : ident := 67%positive.
Definition _p : ident := 71%positive.
Definition _print : ident := 82%positive.
Definition _print_int : ident := 79%positive.
Definition _print_intx : ident := 78%positive.
Definition _ptr_to_int_or_ptr : ident := 64%positive.
Definition _putchar : ident := 57%positive.
...
Definition _test_int_or_ptr : ident := 60%positive.
