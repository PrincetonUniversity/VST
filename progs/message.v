...
Definition _intpair_serialize : ident := 54%positive.
...
Definition _intpair_message : ident := 57%positive.
...
Definition _des : ident := 61%positive.
  ...
  fn_temps := ((_len, tint) :: (_x, tint) :: (_y, tint) ::
               ...
               (_des,
                (tptr (Tfunction
                        ...
                        cc_default))) :: (63%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
      ...
      (Ssequence
        ...
        (Ssequence
          (Ssequence
            ...
            (Sset _len (Etempvar 63%positive tint)))
          (Ssequence
            (Sset _des
              (Efield (Evar _intpair_message (Tstruct _message noattr))
                _deserialize
