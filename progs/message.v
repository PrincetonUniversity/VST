...
Module Info.
  ...
  Definition source_file := "progs/message.c".
...
Definition _buf : ident := 62%positive.
Definition _bufsize : ident := 1%positive.
Definition _des : ident := 70%positive.
Definition _deserialize : ident := 3%positive.
Definition _intpair : ident := 7%positive.
Definition _intpair_deserialize : ident := 65%positive.
Definition _intpair_message : ident := 66%positive.
Definition _intpair_serialize : ident := 63%positive.
Definition _len : ident := 68%positive.
...
Definition _ser : ident := 69%positive.
