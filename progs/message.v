...
Definition _des : ident := 65%positive.
Definition _deserialize : ident := 3%positive.
Definition _intpair : ident := 7%positive.
Definition _intpair_deserialize : ident := 60%positive.
Definition _intpair_message : ident := 61%positive.
Definition _intpair_serialize : ident := 58%positive.
Definition _len : ident := 63%positive.
Definition _length : ident := 59%positive.
...
Definition _ser : ident := 64%positive.
