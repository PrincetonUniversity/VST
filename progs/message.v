...
Definition _des : ident := 62%positive.
Definition _buf : ident := 54%positive.
...
Definition _intpair_deserialize : ident := 57%positive.
...
Definition _ser : ident := 61%positive.
...
Definition _intpair_message : ident := 58%positive.
  ...
  fn_temps := ((_len, tint) :: (_x, tint) :: (_y, tint) ::
               ...
               (_des,
                (tptr (Tfunction
                        ...
                        cc_default))) :: (64%positive, tint) :: nil);
  fn_body :=
(Ssequence
    ...
    (Ssequence
      ...
      (Ssequence
        (Ssequence
          ...
          (Sset _len (Etempvar 64%positive tint)))
        (Ssequence
          (Sset _des
