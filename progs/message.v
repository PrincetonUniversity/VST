...
Definition _q : ident := 46%positive.
...
Definition _length : ident := 43%positive.
Definition ___builtin_va_start : ident := 12%positive.
Definition _len : ident := 47%positive.
Definition ___builtin_annot_intval : ident := 10%positive.
Definition _intpair_deserialize : ident := 44%positive.
Definition ___builtin_negl : ident := 3%positive.
Definition ___builtin_write32_reversed : ident := 2%positive.
Definition ___builtin_write16_reversed : ident := 1%positive.
Definition _struct_message : ident := 36%positive.
...
Definition _struct_intpair : ident := 39%positive.
Definition ___builtin_membar : ident := 11%positive.
Definition _des : ident := 49%positive.
Definition _y : ident := 37%positive.
Definition ___builtin_addl : ident := 4%positive.
Definition ___builtin_fmsub : ident := 28%positive.
Definition ___builtin_fabs : ident := 7%positive.
Definition _intpair_serialize : ident := 42%positive.
