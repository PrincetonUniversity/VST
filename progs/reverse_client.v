...
Module Info.
  ...
  Definition source_file := "progs/reverse_client.c"%string.
...
Definition _head : ident := 3%positive.
Definition _last_foo : ident := ltac:(string2ident "last_foo"%string).
Definition _list : ident := ltac:(string2ident "list"%string).
Definition _main : ident := ltac:(string2ident "main"%string).
Definition _p : ident := 4%positive.
Definition _res : ident := 5%positive.
