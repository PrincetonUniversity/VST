...
Module Info.
  ...
  Definition source_file := "progs/nest2.c"%string.
...
Definition _x1 : ident := 4%positive.
Definition _x2 : ident := 5%positive.
Definition _y1 : ident := 6%positive.
Definition _y2 : ident := 7%positive.
...
(Ssequence
  (Sset _i
    (Efield (Efield (Evar _p (Tstruct _b noattr)) _y2 (Tstruct _a noattr))
      _x2 tint))
...
Definition f_set := {|
  ...
  fn_body :=
(Sassign
  (Efield (Efield (Evar _p (Tstruct _b noattr)) _y2 (Tstruct _a noattr)) _x2
...
(Composite _a Struct ((_x1, tdouble) :: (_x2, tint) :: nil) noattr ::
 Composite _b Struct
...
(_main :: _set :: _get :: _p :: ___builtin_debug :: ___builtin_nop ::
