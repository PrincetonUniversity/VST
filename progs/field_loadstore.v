...
Module Info.
  ...
  Definition source_file := "progs/field_loadstore.c"%string.
...
Definition _j : ident := 4%positive.
Definition _main : ident := ltac:(string2ident "main"%string).
Definition _p : ident := ltac:(string2ident "p"%string).
Definition _sub1 : ident := ltac:(string2ident "sub1"%string).
Definition _sub2 : ident := ltac:(string2ident "sub2"%string).
Definition _sub3 : ident := ltac:(string2ident "sub3"%string).
...
Definition _t'1 : ident := 9%positive.
...
(Composite _a Struct ((_x1, tdouble) :: (_x2, tschar) :: nil) noattr ::
 Composite _b Struct
   ((_y1, tint) :: (_y2, (tarray (Tstruct _a noattr) 3)) :: nil)
   noattr :: nil).
