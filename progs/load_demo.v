...
Definition _get22 : ident := $"get22".
Definition _get_little_endian : ident := $"get_little_endian".
Definition _i : ident := $"i".
Definition _input : ident := $"input".
Definition _int_pair : ident := $"int_pair".
Definition _left : ident := $"left".
Definition _main : ident := $"main".
Definition _obj : ident := $"obj".
Definition _onetwo : ident := $"onetwo".
Definition _p : ident := $"p".
Definition _pair_pair : ident := $"pair_pair".
Definition _pp : ident := $"pp".
Definition _pps : ident := $"pps".
Definition _r : ident := $"r".
Definition _res : ident := $"res".
Definition _res1 : ident := $"res1".
Definition _res2 : ident := $"res2".
Definition _res3 : ident := $"res3".
Definition _right : ident := $"right".
Definition _size : ident := $"size".
Definition _snd : ident := $"snd".
Definition _sum : ident := $"sum".
Definition _tagword : ident := $"tagword".
Definition _threefour : ident := $"threefour".
