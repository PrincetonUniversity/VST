...
Definition _b0 : ident := 69%positive.
Definition _b1 : ident := 70%positive.
Definition _b2 : ident := 71%positive.
Definition _b3 : ident := 72%positive.
Definition _fiddle : ident := 67%positive.
Definition _fst : ident := 1%positive.
Definition _get22 : ident := 62%positive.
Definition _get_little_endian : ident := 73%positive.
Definition _i : ident := 59%positive.
Definition _input : ident := 68%positive.
Definition _int_pair : ident := 3%positive.
Definition _left : ident := 4%positive.
Definition _main : ident := 82%positive.
Definition _obj : ident := 77%positive.
Definition _onetwo : ident := 74%positive.
Definition _p : ident := 60%positive.
Definition _pair_pair : ident := 6%positive.
Definition _pp : ident := 76%positive.
Definition _pps : ident := 58%positive.
Definition _r : ident := 66%positive.
Definition _res : ident := 61%positive.
Definition _res1 : ident := 79%positive.
Definition _res2 : ident := 80%positive.
Definition _res3 : ident := 81%positive.
Definition _right : ident := 5%positive.
Definition _size : ident := 64%positive.
Definition _snd : ident := 2%positive.
Definition _sum : ident := 63%positive.
Definition _tagword : ident := 65%positive.
Definition _threefour : ident := 75%positive.
