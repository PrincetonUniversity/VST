...
Definition _b0 : ident := 3%positive.
Definition _b1 : ident := 4%positive.
Definition _b2 : ident := 5%positive.
Definition _b3 : ident := 6%positive.
Definition _fiddle : ident := ltac:(string2ident "fiddle"%string).
Definition _fst : ident := 7%positive.
Definition _get22 : ident := ltac:(string2ident "get22"%string).
Definition _get_little_endian : ident := ltac:(string2ident "get_little_endian"%string).
Definition _i : ident := 8%positive.
Definition _input : ident := 9%positive.
Definition _int_pair : ident := ltac:(string2ident "int_pair"%string).
Definition _left : ident := 10%positive.
Definition _main : ident := ltac:(string2ident "main"%string).
Definition _obj : ident := 11%positive.
Definition _onetwo : ident := 12%positive.
Definition _p : ident := 13%positive.
Definition _pair_pair : ident := ltac:(string2ident "pair_pair"%string).
Definition _pp : ident := 14%positive.
Definition _pps : ident := 15%positive.
Definition _r : ident := 16%positive.
Definition _res : ident := 17%positive.
Definition _res1 : ident := 18%positive.
Definition _res2 : ident := 19%positive.
Definition _res3 : ident := 20%positive.
Definition _right : ident := 21%positive.
Definition _size : ident := 22%positive.
Definition _snd : ident := 23%positive.
Definition _sum : ident := 24%positive.
Definition _tagword : ident := 25%positive.
Definition _threefour : ident := 26%positive.
Definition _v : ident := 27%positive.
Definition _t'1 : ident := 28%positive.
Definition _t'2 : ident := 29%positive.
Definition _t'3 : ident := 30%positive.
