...
Definition _b0 : ident := 71%positive.
Definition _b1 : ident := 72%positive.
Definition _b2 : ident := 73%positive.
Definition _b3 : ident := 74%positive.
Definition _fiddle : ident := 69%positive.
Definition _fst : ident := 1%positive.
Definition _get22 : ident := 64%positive.
Definition _get_little_endian : ident := 75%positive.
Definition _i : ident := 61%positive.
Definition _input : ident := 70%positive.
Definition _int_pair : ident := 3%positive.
Definition _left : ident := 4%positive.
Definition _main : ident := 84%positive.
Definition _obj : ident := 79%positive.
Definition _onetwo : ident := 76%positive.
Definition _p : ident := 62%positive.
Definition _pair_pair : ident := 6%positive.
Definition _pp : ident := 78%positive.
Definition _pps : ident := 60%positive.
Definition _r : ident := 68%positive.
Definition _res : ident := 63%positive.
Definition _res1 : ident := 81%positive.
Definition _res2 : ident := 82%positive.
Definition _res3 : ident := 83%positive.
Definition _right : ident := 5%positive.
Definition _size : ident := 66%positive.
Definition _snd : ident := 2%positive.
Definition _sum : ident := 65%positive.
Definition _tagword : ident := 67%positive.
Definition _threefour : ident := 77%positive.
