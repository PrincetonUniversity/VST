...
Module Info.
  ...
  Definition source_file := "progs/bin_search.c".
...
Definition _hi : ident := 57%positive.
Definition _lo : ident := 56%positive.
Definition _main : ident := 63%positive.
Definition _mid : ident := 58%positive.
Definition _s : ident := 62%positive.
Definition _search : ident := 60%positive.
Definition _tgt : ident := 55%positive.
