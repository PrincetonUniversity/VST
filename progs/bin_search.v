...
Definition _hi : ident := 52%positive.
Definition _lo : ident := 51%positive.
Definition _main : ident := 58%positive.
Definition _mid : ident := 53%positive.
Definition _s : ident := 57%positive.
Definition _search : ident := 55%positive.
Definition _tgt : ident := 50%positive.
Definition _val : ident := 54%positive.
