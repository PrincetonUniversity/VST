...
Definition _four : ident := ltac:(string2ident "four"%string).
Definition _hi : ident := 4%positive.
Definition _lo : ident := 5%positive.
Definition _main : ident := ltac:(string2ident "main"%string).
Definition _mid : ident := 6%positive.
Definition _s : ident := 7%positive.
Definition _search : ident := ltac:(string2ident "search"%string).
Definition _tgt : ident := 8%positive.
Definition _val : ident := 9%positive.
