...
Definition _auxdata : ident := 53%positive.
Definition _global_auxdata : ident := 56%positive.
Definition _i : ident := 52%positive.
Definition _incr1 : ident := 54%positive.
Definition _incr2 : ident := 55%positive.
Definition _incr3 : ident := 57%positive.
Definition _incr4 : ident := 58%positive.
