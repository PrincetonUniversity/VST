...
Definition _c1 : ident := 85%positive.
Definition _c2 : ident := 86%positive.
Definition _c3 : ident := 87%positive.
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (_c1, tint) :: (_c2, tint) :: (_c3, tint) ::
        ...
        (Ssequence
          ...
          (Ssequence
            ...
            (Sreturn (Some (Ebinop Osub
                             (Ebinop Oadd (Etempvar _c1 tint)
                               (Etempvar _c2 tint) tint)
                             (Ebinop Omul (Econst_int (Int.repr 2) tint)
                               (Etempvar _c3 tint) tint) tint))))))))
...
(_main :: _Triang_nth :: _Onepile_count :: _Onepile_add :: _Onepile_init ::
 _Apile_count :: _Apile_add :: ___builtin_debug :: ___builtin_nop ::
