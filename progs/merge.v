...
Definition _cond : ident := 62%positive.
Definition _head : ident := 1%positive.
Definition _list : ident := 2%positive.
Definition _main : ident := 64%positive.
Definition _merge : ident := 63%positive.
Definition _ret : ident := 57%positive.
Definition _tail : ident := 3%positive.
Definition _temp : ident := 58%positive.
Definition _va : ident := 60%positive.
Definition _vb : ident := 61%positive.
...
(_merge :: ___builtin_debug :: ___builtin_write32_reversed ::
