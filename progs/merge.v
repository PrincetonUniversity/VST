...
Module Info.
  ...
  Definition source_file := "progs/merge.c"%string.
...
Definition _cond : ident := 5%positive.
Definition _head : ident := 6%positive.
Definition _list : ident := ltac:(string2ident "list"%string).
Definition _main : ident := 7%positive.
Definition _merge : ident := ltac:(string2ident "merge"%string).
Definition _ret : ident := 8%positive.
Definition _tail : ident := 9%positive.
Definition _temp : ident := 10%positive.
Definition _va : ident := 11%positive.
Definition _vb : ident := 12%positive.
