...
Definition _cond : ident := 59%positive.
Definition _head : ident := 1%positive.
Definition _list : ident := 2%positive.
Definition _main : ident := 61%positive.
Definition _merge : ident := 60%positive.
Definition _ret : ident := 54%positive.
Definition _tail : ident := 3%positive.
Definition _temp : ident := 55%positive.
Definition _va : ident := 57%positive.
Definition _vb : ident := 58%positive.
