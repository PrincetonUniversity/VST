...
Module Info.
  ...
  Definition source_file := "progs/funcptr.c"%string.
...
Definition _f : ident := 3%positive.
Definition _i : ident := 4%positive.
Definition _j : ident := 5%positive.
Definition _main : ident := ltac:(string2ident "main"%string).
Definition _myfunc : ident := ltac:(string2ident "myfunc"%string).
