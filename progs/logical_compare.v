...
Definition _do_or : ident := 49%positive.
...
(Ssequence
  (Sifthenelse (Etempvar _a tbool)
    (Sset 52%positive (Econst_int (Int.repr 1) tint))
...
Definition f_do_and := {|
  ...
  fn_params := ((_a, tbool) :: (_b, tbool) :: nil);
  fn_vars := nil;
  fn_temps := ((53%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Sifthenelse (Etempvar _a tbool)
    (Sset 53%positive (Ecast (Etempvar _b tbool) tbool))
