...
Definition _do_or : ident := 32%positive.
...
Definition _b : ident := 31%positive.
...
Definition _do_and : ident := 33%positive.
...
Definition _a : ident := 30%positive.
...
Definition f_do_or := {|
  ...
  fn_vars := nil;
  fn_temps := ((35%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Sifthenelse (Etempvar _a tbool)
    (Sset 35%positive (Econst_int (Int.repr 1) tint))
    (Ssequence
      (Sset 35%positive (Ecast (Etempvar _b tbool) tbool))
      (Sset 35%positive (Ecast (Etempvar 35%positive tbool) tint))))
  (Sreturn (Some (Etempvar 35%positive tint))))
|}.
...
Definition f_do_and := {|
  ...
  fn_params := ((_a, tbool) :: (_b, tbool) :: nil);
  fn_vars := nil;
  fn_temps := ((36%positive, tint) :: nil);
  fn_body :=
(Ssequence
  (Sifthenelse (Etempvar _a tbool)
    (Ssequence
      (Sset 36%positive (Ecast (Etempvar _b tbool) tbool))
      (Sset 36%positive (Ecast (Etempvar 36%positive tbool) tint)))
    (Sset 36%positive (Econst_int (Int.repr 0) tint)))
  (Sreturn (Some (Etempvar 36%positive tint))))
|}.
