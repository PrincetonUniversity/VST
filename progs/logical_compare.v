...
Module Info.
  ...
  Definition source_file := "progs/logical_compare.c"%string.
...
Definition _do_and : ident := ltac:(string2ident "do_and"%string).
Definition _do_or : ident := ltac:(string2ident "do_or"%string).
