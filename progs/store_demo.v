...
Module Info.
  ...
  Definition source_file := "progs/store_demo.c".
...
Definition _fiddle : ident := 65%positive.
...
Definition _obj : ident := 69%positive.
Definition _onetwo : ident := 66%positive.
Definition _p : ident := 63%positive.
Definition _pair_pair : ident := 6%positive.
Definition _pp : ident := 68%positive.
Definition _pps : ident := 60%positive.
Definition _res1 : ident := 70%positive.
Definition _res2 : ident := 71%positive.
Definition _right : ident := 5%positive.
Definition _set22 : ident := 64%positive.
Definition _snd : ident := 2%positive.
Definition _threefour : ident := 67%positive.
...
(_main :: _fiddle :: _set22 :: ___builtin_debug ::
