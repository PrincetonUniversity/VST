...
Definition _fst : ident := 3%positive.
...
Definition _obj : ident := 6%positive.
Definition _onetwo : ident := 7%positive.
Definition _p : ident := 8%positive.
Definition _pair_pair : ident := ltac:(string2ident "pair_pair"%string).
Definition _pp : ident := 9%positive.
Definition _pps : ident := 10%positive.
Definition _res1 : ident := 11%positive.
Definition _res2 : ident := 12%positive.
Definition _right : ident := 13%positive.
Definition _set22 : ident := ltac:(string2ident "set22"%string).
Definition _snd : ident := 14%positive.
Definition _threefour : ident := 15%positive.
Definition _v : ident := 16%positive.
