...
Definition _fiddle : ident := 60%positive.
...
Definition _obj : ident := 64%positive.
Definition _onetwo : ident := 61%positive.
Definition _p : ident := 58%positive.
Definition _pair_pair : ident := 6%positive.
Definition _pp : ident := 63%positive.
...
Definition _set22 : ident := 59%positive.
Definition _snd : ident := 2%positive.
Definition _threefour : ident := 62%positive.
