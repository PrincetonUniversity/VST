...
Definition _n1 : ident := 56%positive.
Definition _n2 : ident := 57%positive.
Definition _next : ident := 60%positive.
Definition _s1 : ident := 54%positive.
Definition _s2 : ident := 55%positive.
Definition _strcspn_kmp : ident := 61%positive.
