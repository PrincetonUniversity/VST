...
Definition _n1 : ident := 52%positive.
Definition _n2 : ident := 53%positive.
Definition _next : ident := 56%positive.
Definition _s1 : ident := 50%positive.
Definition _s2 : ident := 51%positive.
Definition _strcspn_kmp : ident := 57%positive.
