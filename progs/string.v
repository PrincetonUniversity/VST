...
Definition _next : ident := 54%positive.
...
Definition _n1 : ident := 50%positive.
...
Definition _mallocN : ident := 47%positive.
...
Definition _s2 : ident := 49%positive.
...
Definition _strcspn_kmp : ident := 55%positive.
...
Definition _n2 : ident := 51%positive.
Definition _s1 : ident := 48%positive.
...
(Ssequence
  (Ssequence
    ...
    (Sset _next (Ecast (Etempvar 57%positive (tptr tvoid)) (tptr tint))))
  (Ssequence
