...
Module Info.
  ...
  Definition source_file := "progs/string.c"%string.
...
Definition _n1 : ident := 6%positive.
Definition _n2 : ident := 7%positive.
Definition _next : ident := 8%positive.
Definition _s1 : ident := 9%positive.
Definition _s2 : ident := 10%positive.
Definition _strcspn_kmp : ident := ltac:(string2ident "strcspn_kmp"%string).
Definition _t'1 : ident := 11%positive.
Definition _t'2 : ident := 12%positive.
Definition _t'3 : ident := 13%positive.
Definition _t'4 : ident := 14%positive.
Definition _t'5 : ident := 15%positive.
