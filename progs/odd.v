...
Module Info.
  ...
  Definition source_file := "progs/odd.c"%string.
...
Definition _even : ident := ltac:(string2ident "even"%string).
Definition _main : ident := 4%positive.
Definition _n : ident := 5%positive.
Definition _odd : ident := ltac:(string2ident "odd"%string).
...
(_odd :: _even :: ___builtin_debug :: ___builtin_nop ::
