...
#[(*export, after Coq 8.13*)global] Hint Rewrite eval_id_same : go_lower.
#[(*export, after Coq 8.13*)global] Hint Rewrite eval_id_other using solve [clear; intro Hx; inversion Hx] : go_lower.
(*#[(*export, after Coq 8.13*)global] Hint Rewrite Vint_inj' : go_lower.*)
