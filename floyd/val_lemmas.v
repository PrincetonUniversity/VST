...
#[(*export, after Coq 8.13*)global] Hint Rewrite force_Vint : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @sem_add_pi_ptr using (solve [auto with norm]) : norm.
...
Proof.
  ...
  + simpl in H; destruct H; subst; reflexivity.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite sem_cast_i2i_correct_range using (solve [auto with norm]) : norm.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite sem_cast_neutral_ptr using (solve [auto with norm]): norm.
...
Proof.
  intros. reflexivity.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite sem_cast_neutral_Vint : norm.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite sem_cast_neutral_int using
  (auto;
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @sizeof_tuchar: norm.

#[(*export, after Coq 8.13*)global] Hint Rewrite Z.mul_1_l Z.mul_1_r Z.add_0_l Z.add_0_r Z.sub_0_r : norm.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite Int.sub_idem Int.sub_zero_l  Int.add_neg_zero : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite Ptrofs.sub_idem Ptrofs.sub_zero_l  Ptrofs.add_neg_zero : norm.

Lemma eval_expr_Etempvar:
  forall {cs: compspecs}  i t, eval_expr (Etempvar i t) = eval_id i.
Proof. reflexivity.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @eval_expr_Etempvar : eval.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @eval_expr_binop : eval.

Lemma eval_expr_unop: forall {cs: compspecs} op a1 t, eval_expr (Eunop op a1 t) =
          lift1 (eval_unop op (typeof a1)) (eval_expr a1).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @eval_expr_unop : eval.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite Int.add_zero  Int.add_zero_l Int.sub_zero_l : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite Ptrofs.add_zero  Ptrofs.add_zero_l Ptrofs.sub_zero_l : norm.

Lemma eval_var_env_set:
  forall i t j v (rho: environ), eval_var i t (env_set rho j v) = eval_var i t rho.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite eval_var_env_set : norm.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @eval_expropt_Some @eval_expropt_None : eval.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite deref_noload_tarray : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite flip_lifted_eq : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite isptr_deref_noload using reflexivity : norm.
