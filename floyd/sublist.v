...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @ZtoNat_Zlength : norm.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite (Znth_map Int.zero) (Znth_map Vundef)
    using (auto; rewrite ?Zlength_map in *; lia) : sublist.
*)
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @Znth_0_cons : sublist.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @app_nil_l @app_nil_r : sublist.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @sublist_nil' using old_list_solve: sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @app_nil_l : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Zlength_rev : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @sublist_rejoin' using old_list_solve : sublist.

Lemma subsub1:
 forall a b : Z, (a-(a-b)) = b.
Proof.  intros. lia. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite subsub1 : sublist.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @Znth_Zrepeat using lia : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Znth_repeat_inrange using lia : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Zlength_cons @Zlength_nil: sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Zrepeat_neg using lia : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @repeat_0 @Zrepeat_0: sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @app_nil_end : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Zlength_app: sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Zlength_map: sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Zlength_Zrepeat using old_list_solve: sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Zlength_repeat using old_list_solve: sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite Z.sub_0_r Z.add_0_l Z.add_0_r : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Zlength_sublist using old_list_solve: sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite Z.max_r Z.max_l using lia : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite Z.min_r Z.min_l using lia : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite Z.add_simpl_r Z.sub_add Z.sub_diag : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @sublist_sublist using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @sublist_app1 using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @sublist_app2 using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @sublist_repeat @sublist_Zrepeat using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @sublist_same using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite Z.add_simpl_l : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite Z.add_add_simpl_l_l Z.add_add_simpl_l_r
     Z.add_add_simpl_r_l Z.add_add_simpl_r_r : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite Z.add_0_r : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @app_Znth1 using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @app_Znth2 using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Znth_sublist using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @upd_Znth_Zlength using old_list_solve : sublist.


#[(*export, after Coq 8.13*)global] Hint Rewrite @sublist_nil : sublist.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @upd_Znth_app1 using old_list_solve : sublist.
#[(*export, after Coq 8.13*)global] Hint Rewrite @upd_Znth_app2 using old_list_solve : sublist.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @map_repeat @map_Zrepeat: sublist.
