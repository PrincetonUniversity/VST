...
(*after Coq 8.13: #[export]*) Hint Rewrite @lift0_unfold @lift1_unfold @lift2_unfold @lift3_unfold @lift4_unfold : norm2.
(*after Coq 8.13: #[export]*) Hint Rewrite @lift0_unfoldC @lift1_unfoldC @lift2_unfoldC @lift3_unfoldC @lift4_unfoldC : norm2.
...
(*after Coq 8.13: #[export]*) Hint Rewrite @alift0_unfold @alift1_unfold @alift2_unfold @alift3_unfold @alift4_unfold : norm2.
...
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_lift0' : subst.
...
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_lift0 (*@subst_lift0'*) @subst_lift0C : subst.
...
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_lift1 (*@subst_lift1'*) @subst_lift1C  : subst.
...
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_lift2 (*@subst_lift2'*) @subst_lift2C : subst.
...
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_lift3 (*@subst_lift3'*) @subst_lift3C : subst.
...
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_lift4 (*@subst_lift4'*) @subst_lift4C : subst.
...
f_equal.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite simpl_get_result1: norm.
...
Proof. intros. unfold retval, get_result1. simpl.
 normalize.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite retval_get_result1 : norm.
...
Abort.
(* (*after Coq 8.13: #[export]*) Hint Rewrite retval_ext_rval : norm. *)
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite retval_lemma1 : norm.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite retval_make_args: norm2.

Lemma andp_makeargs:
   forall (a b: environ -> mpred) d e,
   `(a && b) (make_args d e) = `a (make_args d e) && `b (make_args d e).
Proof. intros. reflexivity. Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite andp_makeargs: norm2.
...
Lemma local_makeargs:
   ...
   `(local (`(f) retval)) (make_args (cons ret_temp nil) (cons v nil))
    = (local (`(f) `(v))).
Proof. intros. reflexivity. Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite local_makeargs: norm2.

Lemma simpl_and_get_result1:
  forall (Q R: environ->mpred) i,
    `(Q && R) (get_result1 i) = `Q (get_result1 i) && `R (get_result1 i).
Proof. intros. reflexivity. Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite simpl_and_get_result1 : norm2.

Lemma liftx_local_retval:
  forall (P: val -> Prop) i,
   `(local (`P retval)) (get_result1 i) = local (`P (eval_id i)).
Proof. intros. reflexivity. Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite liftx_local_retval : norm2.

(*after Coq 8.13: #[export]*) Hint Rewrite bool_val_notbool_ptr using apply Coq.Init.Logic.I : norm.
...
(*after Coq 8.13: #[export]*) Hint Rewrite typed_true_isptr using apply Coq.Init.Logic.I : norm.
...
(*after Coq 8.13: #[export]*) Hint Rewrite sem_cast_pointer2' using (try apply Coq.Init.Logic.I; try assumption; reflexivity) : norm.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite is_pointer_or_null_force_int_ptr using assumption : norm1.
...
intros. destruct v; inv H; reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite is_pointer_force_int_ptr using assumption : norm1.
...
intros. destruct v; inv H; reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite is_pointer_or_null_match using assumption : norm1.
...
intros. destruct v; inv H; reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite is_pointer_force_int_ptr2 using assumption : norm1.
...
(*after Coq 8.13: #[export]*) Hint Rewrite is_pointer_or_null_force_int_ptr2 using assumption : norm1.
...
(*after Coq 8.13: #[export]*) Hint Rewrite isptr_match : norm1.
...
(*after Coq 8.13: #[export]*) Hint Rewrite eval_cast_neutral_tc_val using solve [eauto] : norm.
...
intros. destruct v; inv H; reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite eval_cast_neutral_is_pointer_or_null using assumption : norm.
...
(*after Coq 8.13: #[export]*) Hint Rewrite is_pointer_or_null_eval_cast_neutral : norm.
...
intros. destruct v; inv H; reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite eval_cast_neutral_isptr using assumption : norm.
...
Proof. reflexivity. Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite raise_sepcon : norm1.
...
Proof.
 reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite lift_lift_retval: norm2.
...
Proof. reflexivity. Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite lift_lift_x : norm2.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @lift0_exp : norm2.
(*after Coq 8.13: #[export]*) Hint Rewrite @lift0C_exp : norm2.
...
(*after Coq 8.13: #[export]*) Hint Rewrite (@lift0C_sepcon mpred _ _) : norm.
(*after Coq 8.13: #[export]*) Hint Rewrite (@lift0C_andp mpred _) : norm.
(*after Coq 8.13: #[export]*) Hint Rewrite (@lift0C_exp mpred _) : norm.
(*after Coq 8.13: #[export]*) Hint Rewrite (@lift0C_later mpred _ _) : norm.
(*after Coq 8.13: #[export]*) Hint Rewrite (@lift0C_prop mpred _) : norm.
...
Proof. reflexivity. Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @fst_unfold @snd_unfold : norm.
...
(*after Coq 8.13: #[export]*) Hint Rewrite local_andp_prop local_andp_prop1 : norm2.
...
apply pred_ext; normalize.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite local_sepcon_assoc1 local_sepcon_assoc2 : norm2.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite prop_true_andp1 using solve [auto 3 with typeclass_instances]: norm1.
(*after Coq 8.13: #[export]*) Hint Rewrite prop_true_andp1 using assumption : norm.
...
(*after Coq 8.13: #[export]*) Hint Rewrite and_assoc_splittablex using 
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite prop_and1 using solve [auto 3 with typeclass_instances] : norm2.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_make_args' using (solve[reflexivity]) : subst.

Lemma map_cons: forall {A B} (f: A -> B) x y,
   map f (x::y) = f x :: map f y.
Proof. reflexivity. Qed.

(*after Coq 8.13: #[export]*) Hint Rewrite @map_cons : norm.
(*after Coq 8.13: #[export]*) Hint Rewrite @map_cons : subst.

Lemma map_nil: forall {A B} (f: A -> B), map f nil = nil.
Proof. reflexivity. Qed.

(*after Coq 8.13: #[export]*) Hint Rewrite @map_nil : norm.
(*after Coq 8.13: #[export]*) Hint Rewrite @map_nil : subst.
...
apply IHl.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_stackframe_of : subst.
...
(*after Coq 8.13: #[export]*) Hint Rewrite wand_sepcon wand_sepcon' : norm.
