...
#[(*export, after Coq 8.13*)global] Hint Rewrite @Znth_repeat_inrange using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite @Znth_sublist using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite Znth_app1 Znth_app2 using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite Znth_Zrepeat using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite Znth_upd_Znth_same Znth_upd_Znth_diff using Zlength_solve : Znth.

#[(*export, after Coq 8.13*)global] Hint Rewrite (@Znth_map _ Inhabitant_Z) using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite (@Znth_map _ Inhabitant_nat) using Zlength_solve : Znth.
