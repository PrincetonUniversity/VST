...
Ltac check_non_zero_loop_old :=
  ...
  then fail 0 "The goal has non-zero loop"
  else idtac.
...
Ltac list_prop_solve :=
  list_prop_solve';
  fail 0 "list_prop_solve cannot solve this goal".
...
Ltac list_solve :=
  ...
  try list_prop_solve;
  fail 0 "list_solve cannot solve the goal".
...
Ltac list_solve2 :=
  list_solve2';
  fail 0 "list_solve2 cannot solve this goal".
