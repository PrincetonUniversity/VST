...
Lemma semax_call': forall Espec {cs: compspecs} Delta fs A Pre Post NEPre NEPost ts x ret argsig retsig cc a bl P Q R,
   ...
   (Hsub: funspec_sub_weak fs (mk_funspec (argsig,retsig) cc A Pre Post NEPre NEPost))
...
Lemma semax_call0: forall Espec {cs: compspecs} Delta fs A Pre Post NEPre NEPost ts x
   ...
   (Hsub: funspec_sub_weak fs (mk_funspec (argsig,retty) cc A Pre Post NEPre NEPost)),
...
Definition call_setup1 
 ...
 :=
  ...
  funspec_sub_weak fs (mk_funspec (argsig,retty) cc A Pre Post NEPre NEPost) /\
