...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite align_0 using lia : norm.

Lemma align_1: forall n, align n 1 = n.
Proof.  intros; unfold align. rewrite Z.div_1_r. rewrite Z.mul_1_r. lia.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite align_1 using lia : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite proj_sumbool_is_true using (solve [auto 3]) : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite proj_sumbool_is_false using (solve [auto 3]) : norm.
