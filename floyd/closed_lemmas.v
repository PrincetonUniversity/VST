...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @closed_env_set using safe_auto_with_closed : norm2.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite subst_eval_id_eq : subst.
#[(*export, after Coq 8.13*)global] Hint Rewrite subst_eval_id_neq using safe_auto_with_closed : subst.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @subst_eval_expr_eq @subst_eval_lvalue_eq : subst.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @closed_wrt_map_subst using safe_auto_with_closed : subst.
#[(*export, after Coq 8.13*)global] Hint Rewrite @closed_wrt_subst using safe_auto_with_closed : subst.
...
(*#[(*export, after Coq 8.13*)global] Hint Rewrite @closed_wrt_map_subst' using safe_auto_with_closed : norm.*)
#[(*export, after Coq 8.13*)global] Hint Rewrite @closed_wrt_map_subst' using safe_auto_with_closed : subst.
...
apply closed_wrt_subst; auto.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @closed_wrt_subst_eval_expr using solve [auto 50 with closed] : subst.
#[(*export, after Coq 8.13*)global] Hint Rewrite @closed_wrt_subst_eval_lvalue using solve [auto 50 with closed] : subst.
