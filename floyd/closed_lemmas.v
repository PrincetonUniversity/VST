...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @closed_env_set using safe_auto_with_closed : norm2.
...
(*after Coq 8.13: #[export]*) Hint Rewrite subst_eval_id_eq : subst.
(*after Coq 8.13: #[export]*) Hint Rewrite subst_eval_id_neq using safe_auto_with_closed : subst.
...
(*after Coq 8.13: #[export]*) Hint Rewrite @subst_eval_expr_eq @subst_eval_lvalue_eq : subst.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @closed_wrt_map_subst using safe_auto_with_closed : subst.
(*after Coq 8.13: #[export]*) Hint Rewrite @closed_wrt_subst using safe_auto_with_closed : subst.
...
(*(*after Coq 8.13: #[export]*) Hint Rewrite @closed_wrt_map_subst' using safe_auto_with_closed : norm.*)
(*after Coq 8.13: #[export]*) Hint Rewrite @closed_wrt_map_subst' using safe_auto_with_closed : subst.
...
apply closed_wrt_subst; auto.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @closed_wrt_subst_eval_expr using solve [auto 50 with closed] : subst.
(*after Coq 8.13: #[export]*) Hint Rewrite @closed_wrt_subst_eval_lvalue using solve [auto 50 with closed] : subst.
