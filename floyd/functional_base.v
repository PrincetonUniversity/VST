...
#[(*export, after Coq 8.13*)global] Hint Rewrite (@Znth_map _ Inhabitant_float32) using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite (@Znth_map _ Inhabitant_ptrofs) using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite (@Znth_map _ Inhabitant_int64) using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite (@Znth_map _ Inhabitant_byte) using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite (@Znth_map _ Inhabitant_int) using Zlength_solve : Znth.
#[(*export, after Coq 8.13*)global] Hint Rewrite (@Znth_map _ Inhabitant_val) using Zlength_solve : Znth.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- offset_val_force_ptr : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite offset_offset_val: norm.

#[(*export, after Coq 8.13*)global] Hint Rewrite add_repr add64_repr ptrofs_add_repr : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite mul_repr mul64_repr ptrofs_mul_repr : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite sub_repr sub64_repr ptrofs_sub_repr : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite and_repr and64_repr : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite or_repr or64_repr : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite neg_repr neg64_repr : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite int_add_assoc1 : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite ptrofs_add_assoc1 : norm.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite force_val_e: norm.
...
Qed.
(* #[(*export, after Coq 8.13*)global] Hint Rewrite ptr_eq_True' using solve[auto] : norm. *)
...
#[(*export, after Coq 8.13*)global] Hint Rewrite isptr_offset_val_zero using solve [auto] : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite isptr_offset_val : norm.

Lemma isptr_force_ptr: forall v, isptr v -> force_ptr v = v.
Proof. intros. destruct v; inv H; auto. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite isptr_force_ptr using solve [auto] : norm.

Lemma isptr_force_ptr' : forall p, isptr (force_ptr p) =  isptr p.
Proof.
intros. destruct p; reflexivity.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite isptr_force_ptr' : norm.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite sign_ext_inrange using assumption : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite zero_ext_inrange using assumption : norm.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite force_signed_int_e : norm.
...
Proof.
  ...
  apply Znth_map.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite Znth_map_Vbyte using old_list_solve : norm entailer_rewrite.
...
Proof.
  ...
  apply Znth_map.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite Znth_map_Vubyte using old_list_solve : norm entailer_rewrite.
