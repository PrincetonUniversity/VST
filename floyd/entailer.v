...
#[(*export, after Coq 8.13*)global] Hint Rewrite ptrofs_of_ints_unfold : norm.

Lemma ptrofs_of_intu_unfold: 
  forall x, Ptrofs.of_intu x = Ptrofs.repr (Int.unsigned x).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite ptrofs_of_intu_unfold : norm.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite (@TT_andp mpred _) : gather_prop.
#[(*export, after Coq 8.13*)global] Hint Rewrite (@andp_TT mpred _) : gather_prop.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite intsigned_intrepr_bytesigned : rep_lia.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite Int.signed_repr using rep_lia : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite Int.unsigned_repr using rep_lia : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite Int64.signed_repr using rep_lia : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite Int64.unsigned_repr using rep_lia : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite offset_val_sizeof_hack : norm.
...
apply prop_ext; tauto.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite offset_val_sizeof_hack2 : norm.
...
apply prop_ext; tauto.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite offset_val_sizeof_hack3 : norm.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite Zmax0r using (try computable; rep_lia (*Omega0*)) : norm.
