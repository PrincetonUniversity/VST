...
#[export] Hint Extern 1 (data_at _ (tarray _ _) _ _ |-- _) =>
  (apply data_array_at_local_facts) : saturate_local.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @field_at_offset_zero: norm1.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @field_at__offset_zero: norm1.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @field_at_offset_zero: cancel.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @field_at__offset_zero: cancel.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @data_at__offset_zero: norm1.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @data_at_offset_zero: norm1.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @data_at__offset_zero: cancel.
#[(*export, after Coq 8.13*)global] Hint Rewrite <- @data_at_offset_zero: cancel.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @is_pointer_or_null_field_address_lemma : entailer_rewrite.
#[(*export, after Coq 8.13*)global] Hint Rewrite @isptr_field_address_lemma : entailer_rewrite.
