...
#[(*export, after Coq 8.13*)global] Hint Rewrite <- prop_and_mpred : gather_prop.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite gather_prop_left gather_prop_right : gather_prop.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite flip_prop using not_a_prop : gather_prop.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite gather_prop3 using not_a_prop : gather_prop.

Lemma gather_prop4:
  forall P Q R,  not_a_prop R -> not_a_prop Q -> (!!P && R) && Q = !!P && (R && Q).
Proof. intros. rewrite andp_assoc. auto.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite gather_prop4 using not_a_prop : gather_prop.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite gather_prop5 using not_a_prop : gather_prop.

#[(*export, after Coq 8.13*)global] Hint Rewrite sepcon_andp_prop sepcon_andp_prop' : gather_prop gather_prop_core.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite TEST_L using reflexivity : test888.
