...
#[(*export, after Coq 8.13*)global] Hint Rewrite insert_local (*insert_tce*) :  norm2.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @fold_right_nil : norm1.
#[(*export, after Coq 8.13*)global] Hint Rewrite @fold_right_nil : subst.

Lemma fold_right_cons: forall {A B} (f: A -> B -> B) (z: B) x y,
   fold_right f z (x::y) = f x (fold_right f z y).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @fold_right_cons : norm1.
#[(*export, after Coq 8.13*)global] Hint Rewrite @fold_right_cons : subst.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite local_unfold : norm2.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite lower_sepcon lower_andp : norm2.

Lemma lift_prop_unfold:
   forall P z,  @prop (environ->mpred) _ P z = @prop mpred Nveric P.
Proof.  reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite lift_prop_unfold: norm2.

Lemma andp_unfold: forall (P Q: environ->mpred) rho,
  @andp (environ->mpred) _ P Q rho = @andp mpred Nveric (P rho) (Q rho).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite andp_unfold: norm2.

Lemma refold_andp:
  forall (P Q: environ -> mpred),
     (fun rho: environ => P rho && Q rho) = (P && Q).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite refold_andp : norm2.
...
intros. reflexivity.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite exp_unfold: norm2.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @local_lift0: norm2.
...
(* #[(*export, after Coq 8.13*)global] Hint Rewrite move_prop_from_SEP move_local_from_SEP : norm. *)
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite lower_PROP_LOCAL_SEP : norm2.

Lemma lower_TT: forall rho, @TT (environ->mpred) _ rho = @TT mpred Nveric.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite lower_TT : norm2.

Lemma lower_FF: forall rho, @FF (environ->mpred) _ rho = @FF mpred Nveric.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite lower_FF : norm2.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @split_first_PROP using not_conj_notation : norm1.
