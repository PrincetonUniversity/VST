...
(*after Coq 8.13: #[export]*) Hint Rewrite @sem_add_pi_ptr_special' using (solve [try reflexivity; auto with norm]) : norm.
(*after Coq 8.13: #[export]*) Hint Rewrite @sem_add_pl_ptr_special' using (solve [try reflexivity; auto with norm]) : norm.
...
(*after Coq 8.13: #[export]*) Hint Rewrite <- @prop_and using solve [auto with typeclass_instances]: norm1.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite tc_option_val'_eq : norm.

Lemma emp_make_ext_rval:
  forall ge t v, @emp (environ->mpred) _ _ (make_ext_rval ge t v) = emp.
Proof. reflexivity. Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite emp_make_ext_rval : norm2.
...
f_equal; auto.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite Byte_signed_lem: norm entailer_rewrite.
...
subst; reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite int_repr_byte_signed_eq0: norm entailer_rewrite.
...
subst; reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite int_repr_byte_signed_eq: norm entailer_rewrite.
...
(*after Coq 8.13: #[export]*) Hint Rewrite eqb_ident_true : subst.
(*after Coq 8.13: #[export]*) Hint Rewrite eqb_ident_false using solve [auto] : subst.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite subst_temp_special using safe_auto_with_closed: subst.
...
Proof. reflexivity. Qed.
(*(*after Coq 8.13: #[export]*) Hint Rewrite subst_make_args1 : norm2.*)
(*(*after Coq 8.13: #[export]*) Hint Rewrite subst_make_args1 : subst.*)
...
rewrite H. reflexivity.
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @sem_add_ptr_int_lem using (try reflexivity; assumption) : norm1.
...
Qed.
(*after Coq 8.13: #[export]*) Hint Rewrite @sem_add_pi' using (solve [try reflexivity; auto with norm ; rep_lia]) : norm.
