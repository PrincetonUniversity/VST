...
#[(*export, after Coq 8.13*)global] Hint Rewrite loop1x_ret_assert_EK_normal: ret_assert.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite RA_normal_loop2_ret_assert : ret_assert.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite frame_normal frame_for1 frame_loop1
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite overridePost_overridePost : ret_assert.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite overridePost_normal' : ret_assert.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @liftx_id : norm2.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @liftx3_liftx2 @liftx2_liftx1 @liftx1_liftx0 : norm2.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @lift1_lift0 : norm2.

Lemma const_liftx0:
  forall B (P: B), (fun _ : environ => P) = `P.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite const_liftx0 : norm2.

Lemma lift_identity:
  forall A f, `(fun v: A => v) f = f.
Proof. intros. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite lift_identity : norm2.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite local_lift2_and : norm2.
...
intros. extensionality rho; reflexivity.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @subst_TT @subst_FF: subst.
#[(*export, after Coq 8.13*)global] Hint Rewrite (@subst_TT mpred Nveric) (@subst_FF mpred Nveric): subst.

Lemma subst_sepcon: forall i v (P Q: environ->mpred),
  subst i v (P * Q) = (subst i v P * subst i v Q).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite subst_sepcon : subst.

Lemma subst_wand: forall i v (P Q: environ->mpred),
  subst i v (P -* Q) = (subst i v P -* subst i v Q).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite subst_wand : subst.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @resubst : subst.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite subst_ewand : subst.
...
intros; reflexivity.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @subst_andp subst_prop : subst.

Lemma eval_expr_Econst_int: forall {cs: compspecs}  i t, eval_expr (Econst_int i t) = `(Vint i).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @eval_expr_Econst_int : eval.
...
simpl. auto.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite subst_eval_var : subst.

Lemma subst_local: forall id v P,
  subst id v (local P) = local (subst id v P).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite subst_local : subst.

Lemma eval_lvalue_Ederef:
  forall {cs: compspecs}  e t, eval_lvalue (Ederef e t) = eval_expr e.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @eval_lvalue_Ederef : eval.

Lemma local_lift0_True:     local (`True) = TT.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite local_lift0_True : norm2.
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite overridePost_EK_return : ret_assert.
...
(*#[(*export, after Coq 8.13*)global] Hint Rewrite frame_ret_assert_emp : ret_assert.*)
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite frame_ret_assert_EK_return : ret_assert.

Lemma function_body_ret_assert_EK_return:
  forall t P vl, RA_return (function_body_ret_assert t P) vl = bind_ret vl t P.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite function_body_ret_assert_EK_return : ret_assert.

Lemma bind_ret1_unfold:
  forall v t Q, bind_ret (Some v) t Q = !!tc_val t v && `Q (make_args (ret_temp :: nil)(v::nil)).
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite bind_ret1_unfold : norm2.
...
Proof.
 intros. reflexivity.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite bind_ret1_unfold' : norm2.  (* put this in AFTER the unprimed version, for higher priority *)
...
#[(*export, after Coq 8.13*)global] Hint Rewrite overridePost_EK_break loop1_ret_assert_EK_break
...
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite loop1_ret_assert_normal: ret_assert.

Lemma unfold_make_args': forall fsig args rho,
    make_args' fsig args rho = make_args (map (@fst _ _) (fst fsig)) (args rho) rho.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite unfold_make_args' : norm2.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite unfold_make_args_cons unfold_make_args_nil : norm2.
...
Lemma clear_rhox:  (* replaces clear_make_args' *)
 forall (P: mpred) (f: environ -> environ),
    @liftx (Tarrow environ (LiftEnviron mpred))
       ...
       = `P.
Proof. intros. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite clear_rhox: norm2.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite eval_make_args' : norm2.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @eval_make_args_same : norm2.
#[(*export, after Coq 8.13*)global] Hint Rewrite @eval_make_args_other using (solve [clear; intro Hx; inversion Hx]) : norm.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite compose_backtick : norm.
...
#[(*export, after Coq 8.13*)global] Hint Rewrite @compose_eval_make_args_same : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite @compose_eval_make_args_other using (solve [clear; intro Hx; inversion Hx]) : norm.
...
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite @substopt_unfold @substopt_unfold_nil : subst.

Lemma get_result_unfold: forall id, get_result (Some id) = get_result1 id.
Proof. reflexivity. Qed.
Lemma get_result_None: get_result None = globals_only.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite get_result_unfold get_result_None : norm.
...
auto.
Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite elim_globals_only using (split3; [eassumption | reflexivity.. ]) : norm.

Lemma elim_globals_only':
 forall a: mpred,
 (@liftx (Tarrow environ (LiftEnviron mpred)) (`a) globals_only) = `a.
Proof. reflexivity. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite elim_globals_only' : norm.
...
Proof. easy. Qed.
#[(*export, after Coq 8.13*)global] Hint Rewrite globvars2pred_unfold : norm.
#[(*export, after Coq 8.13*)global] Hint Rewrite @exp_trivial : norm.
