...
Lemma injinj: Coop_forward_simulation_inj.Forward_simulation_inject (list (ident * globdef F1 V1))
                                         (list (ident * globdef F3 V3)) Sem1 Sem3 (Genv.globalenv P1)
                                        (Genv.globalenv P3) entrypoints13.
Proof.
...
Context {F1 C1 V1 F2 C2 V2 F3 C3 V3} 
       ...
       (SimEq23 : Forward_simulation_eq.Forward_simulation_equals mem (list (ident * globdef F2 V2))
                                         ...
                                         (Genv.globalenv P3) epts23) .
(*
Let D12:Type:= Forward_simulation_eq.core_data SimEq12.
Let D23:Type:= Forward_simulation_eq.core_data SimEq23.

  Let data13 := (Forward_simulation_eq.core_data SimEq12 * (option C2) * Forward_simulation_eq.core_data SimEq23)%type.

  Inductive sem_compose_ord 
      : (*data13 -> data13 -> Prop :=*)
 (prod (prod (Forward_simulation_eq.core_data SimEq12) (option C2)) (Forward_simulation_eq.core_data SimEq23)) ->
 (prod (prod (Forward_simulation_eq.core_data SimEq12) (option C2)) (Forward_simulation_eq.core_data SimEq23)) -> Prop :=

    | sem_compose_ord1 :
        forall (d12 d12':Forward_simulation_eq.core_data SimEq12) (c2:C2) (d23:Forward_simulation_eq.core_data SimEq23),
           Forward_simulation_eq.core_ord SimEq12  d12 d12' ->
           sem_compose_ord (d12,Some c2,d23) (d12',Some c2,d23)
    | sem_compose_ord2 :
        forall (d12 d12':Forward_simulation_eq.core_data SimEq12) (c2 c2':C2) (d23 d23':Forward_simulation_eq.core_data SimEq23),
           Forward_simulation_eq.core_ord  SimEq23 d23 d23' ->
           sem_compose_ord (d12,Some c2,d23) (d12',Some c2',d23').
...
(*    set (q := (d23,c)).
    ...
    clear d23.*)
   revert c. 
    induction d23 using (well_founded_induction (Forward_simulation_eq.core_ord_wf SimEq23)).
    intros.
(*    set (q' := (d12,c)).
    change d12 with (fst q'). change c with (snd q').
    clearbody q'. clear d12 c.*)
    induction d12 using (well_founded_induction (Forward_simulation_eq.core_ord_wf SimEq12)).
    constructor; intros. inv H1.
    generalize (H0 d0). simpl. intros.
