...
(* CompCert 3.17 replaced the [typelist] type ([Tnil]/[Tcons]) with [list type].
   This file was generated by clightgen 3.10; map the old constructors onto lists. *)
Local Notation Tnil := (@nil type) (only parsing).
Local Notation Tcons := (@cons type) (only parsing).

(* CompCert 3.17 also replaced [AST.rettype] with [AST.xtype] and renamed its
   constructors T* -> X*, and retyped [sig_args] from [list typ] to [list xtype].
   The occurrences below were renamed in place rather than shimmed, because they are
   written qualified ([AST.Tint]) and a [Local Notation] cannot shadow a qualified
   name.  The rename is meaning-preserving: [proj_xtype Xint = Tint] and likewise
   for Xlong/Xfloat/Xsingle, so the argument lists denote the same [typ] list as
   before, and [Xvoid]/[Xint16unsigned] are the direct successors of the old
   [rettype] constructors of those names.  This is also exactly what clightgen 3.17
   emits for these tokens.  We deliberately do NOT regenerate the whole file: the
   3.17 output drops identifiers this development refers to and changes the pointer
   depth of [gvar_info], which breaks proofs silently. *)
...
((___compcert_va_int32,
 ...
 (___builtin_memcpy_aligned,
   Gfun(External (EF_builtin "__builtin_memcpy_aligned"
                   (mksignature
                     (AST.Xlong :: AST.Xlong :: AST.Xlong :: AST.Xlong ::
 ...
 (___builtin_annot,
   Gfun(External (EF_builtin "__builtin_annot"
                   (mksignature (AST.Xlong :: nil) AST.Xvoid
                     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
     (Tcons (tptr tschar) Tnil) tvoid
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (___builtin_annot_intval,
   Gfun(External (EF_builtin "__builtin_annot_intval"
                   (mksignature (AST.Xlong :: AST.Xint :: nil) AST.Xint
                     cc_default)) (Tcons (tptr tschar) (Tcons tint Tnil))
     tint cc_default)) ::
 (___builtin_membar,
   Gfun(External (EF_builtin "__builtin_membar"
                   (mksignature nil AST.Xvoid cc_default)) Tnil tvoid
     cc_default)) ::
 (___builtin_va_start,
 ...
 (___builtin_va_arg,
   Gfun(External (EF_builtin "__builtin_va_arg"
                   (mksignature (AST.Xlong :: AST.Xint :: nil) AST.Xvoid
                     cc_default)) (Tcons (tptr tvoid) (Tcons tuint Tnil))
     tvoid cc_default)) ::
 (___builtin_va_copy,
   Gfun(External (EF_builtin "__builtin_va_copy"
                   (mksignature (AST.Xlong :: AST.Xlong :: nil) AST.Xvoid
                     cc_default))
 ...
 (___builtin_read16_reversed,
   Gfun(External (EF_builtin "__builtin_read16_reversed"
                   (mksignature (AST.Xlong :: nil) AST.Xint16unsigned
 ...
 (_atom_CAS,
   Gfun(External (EF_external "atom_CAS"
                   (mksignature (AST.Xlong :: AST.Xlong :: AST.Xint :: nil)
                     AST.Xint cc_default))
     (Tcons (tptr (Tstruct _atom_int noattr))
       (Tcons (tptr tint) (Tcons tint Tnil))) tint cc_default)) ::
 (_makelock,
   Gfun(External (EF_external "makelock"
                   (mksignature nil AST.Xlong cc_default)) Tnil
