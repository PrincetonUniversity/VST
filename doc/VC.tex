...
\newthought{Cancel does \emph{not} use} $\beta\eta$ equality,
...
what we need to unfold the lseg, using this lemma:
\begin{lstlisting}
...
\chapter{Restrictions on forward}
...
by using \lstinline{Intros} or \lstinline{normalize}.
\end{itemize}
