...
\item $\mathbf{for}\,(e_1;e_2;e_3)~ s$ \qquad (no \lstinline{break} statements in $s$)\newline
  Use \lstinline{forward_for $Q$ continue: $Q'$}, where $Q$ is the loop invariant
...
\item $\mathbf{for}\,(e_1;e_2;e_3)~ s; \ldots $\newline
  ...
  \lstinline{forward_for $Q$ continue: $Q'$ break: $R$}, where $Q$ and $Q'$ are as above,
...
If your $\mathit{incr}$ is empty (or Sskip), you can omit \ \ \lstinline{continue: $\mathit{PreInc}$}.
