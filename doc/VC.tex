...
\newline The shell script VST/coqide automates this, with
a useful bug workaround as well.
...
\lstinline{Exists (h::cts1,r,v,y).}  (Note that
...
sublist_app1: $0 \le i \le j \le \mathsf{Zlength} al$ -> sublist $i$ $j$ ($l$ ++ $l'$) = sublist $i$ $j$ $l$.
...
Therefore, \lstinline{autorewrite with sublist} is a good way to
