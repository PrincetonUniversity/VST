...
\begin{description}
\item[Coq 8.6,] from coq.inria.fr.  Follow the standard installation instructions.
...
\item[VST 1.8,] from \href{vst.cs.princeton.edu}{vst.cs.princeton.edu},
...
\lstinline{Require Import floyd.library} \emph{after} you
...
DECLARE _free
   ...
   PRE [ 1%positive OF tptr tvoid ]
    ...
    POST [ Tvoid ]
       ...
       SEP ().
\end{lstlisting}
You must \lstinline{Import floyd.library.}
...
\chapter{exit}
\lstinline{Import floyd.library.}
before you define
