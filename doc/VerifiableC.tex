...
\vskip50pt
  \fontsize{14}{16}\selectfont\par\noindent{\itshape Version 1.3.1 \\ \today}
\vskip100pt
\par
\vskip10pt
...
\begin{trivlist}
\item \lstinline{`($E$)} where $E$ is a Coq expression of type \lstinline{mpred}, or
\item \lstinline{`($F$) (evalvar $i$ $t$)}
where $F$ is a Coq expression of type \lstinline{val->mpred}
and $i$ is $\beta\eta$-equivalent to a constant.
\end{trivlist}
\end{itemize}
...
field_at $\pi$ t_struct_list (_head::nil) h p * field_at $\pi$ t_struct_list (_tail::nil) t p
...
We write\newline \lstinline{field_at $\pi$ t_struct_list (_head::nil) h p}
...
which simplify to 
\begin{lstlisting}
`(field_at $\pi$ t_struct_list (_head::nil) h * field_at $\pi$ t_struct_list (_tail::nil) t)
...
\begin{lstlisting}
field_at Tsh t_struct_list (_head::nil) Vundef p 
        * field_at Tsh t_struct_list (_tail::nil) Vundef p
field_at_ Tsh t_struct_list (_head::nil) p * field_at_ Tsh t_struct_list (_tail::nil) p
...
\begin{lstlisting}
field_at Tsh t_struct_list (_head::nil) (Vint(Int.repr 3)) p
        * field_at Tsh t_struct_list (_tail::nil) Vundef p
field_at Tsh t_struct_list (_head::nil) (Vint(Int.repr 3)) 
        * field_at_ Tsh t_struct_list (_tail::nil) p
...
\begin{lstlisting}
field_at Tsh t_struct_list (_head::nil) (Vint(Int.repr 3)) p 
        * field_at Tsh t_struct_list (_tail::nil) (Vint Int.zero) p
