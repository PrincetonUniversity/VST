...
(*after Coq 8.13: #[export]*) Hint Rewrite beq_int_refl : expr_beq.
...
(*after Coq 8.13: #[export]*) Hint Rewrite beq_long_refl : expr_beq.
...
(*after Coq 8.13: #[export]*) Hint Rewrite beq_float_refl : expr_beq.
...
(*after Coq 8.13: #[export]*) Hint Rewrite beq_float32_refl : expr_beq.
...
(*after Coq 8.13: #[export]*) Hint Rewrite unary_op_beq_refl : expr_beq.
...
(*after Coq 8.13: #[export]*) Hint Rewrite binary_op_beq_refl : expr_beq.
...
(*after Coq 8.13: #[export]*) Hint Rewrite Bool.andb_true_iff : expr_beq.
Hint Resolve eqb_type_true : expr_beq.
Hint Resolve BinPos.Peqb_true_eq : expr_beq.
(*after Coq 8.13: #[export]*) Hint Rewrite BinPos.Pos.eqb_refl : expr_beq.
Hint Resolve BinPos.Pos.eqb_refl : expr_beq.
Hint Resolve eqb_type_refl : expr_beq.
(*after Coq 8.13: #[export]*) Hint Rewrite eqb_type_refl : expr_beq.
