...
Ltac forward := start_timer "forward"; repeat forward.forward; stop_timer "forward".
...
cbv [assertD localD LocalD PTree.fold PTree.xfold map].
intros.
forward.
Abort.

Definition sets : nat:= 1%nat.
Definition temps_tycon := sets.
Definition temps_local := 40%nat.
Definition vars_local := temps_local.
Definition seps := temps_local.
