...
Fixpoint assumptionsD types functions meta_env var_env assumptions :=
match assumptions with 
| cons h nil => force_Opt (@Expr.exprD types functions meta_env var_env h tvProp) True 
| cons h t => force_Opt (@Expr.exprD types functions meta_env var_env h tvProp) True -> assumptionsD types functions meta_env var_env t
| nil => True
end.
