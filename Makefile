...
VERIC_FILES= \
  ...
  tycontext.v lift.v expr.v environ_lemmas.v binop_lemmas.v \
...
FLOYD_FILES= \
   coqlib3.v base.v proofauto.v type_induction.v reptype_lemmas.v aggregate_type.v aggregate_pred.v \
